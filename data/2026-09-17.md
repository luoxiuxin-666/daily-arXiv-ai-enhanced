...
### [3] [One Axis, No Brake: Self-Knowledge Limits the Filtering of Harmful Peer Conformity in LLMs](https://arxiv.org/abs/2609.18998)
*Yibo Hu*
...
### [4] [Pay Only for Disagreement: Certified No-Regression Verdicts for Model Updates with Matching Label-Complexity Bounds](https://arxiv.org/abs/2609.17560)
...
### [5] [Beyond Static RAG: An Adaptive, Tri-Metric Routing Framework for Efficient Long-Context Inference on Commodity GPUs](https://arxiv.org/abs/2609.17564)
...
### [15] [DSD: Learning Diverse and Reusable Motor Skills via Diffusion Skill Discovery](https://arxiv.org/abs/2609.17682)
...
### [16] [The Missing "I Don't Know": Why Three Reasoning-Reliability Findings Converge on Calibrated Abstention](https://arxiv.org/abs/2609.17686)
*Srijith Ravikumar*
...
### [17] [Accelerating Diffusion Sampling via Speculative Draft Trees](https://arxiv.org/abs/2609.17691)
...
### [18] [Composite-Gradient Learning for Shared Control Authority Between Deep Reinforcement Learning and Model Predictive Control](https://arxiv.org/abs/2609.17697)
...
### [19] [REVERSAL-BENCH: A Reversibility Axis and Reset Oracle for Measuring the Reset-Free RL Cliff](https://arxiv.org/abs/2609.17745)
...
### [20] [SAM-on-the-Curve: Sharpness-Aware Mode Connectivity for Robust Weight-Space Interpolation](https://arxiv.org/abs/2609.17748)
...
### [21] [Modular Deep Learning Mechanisms for Auditable Next-Day Wildfire Spread Prediction](https://arxiv.org/abs/2609.17763)
...
### [22] [Principled Koopman Representations with Kalman Inference for Efficient Time-Series Prediction](https://arxiv.org/abs/2609.17815)
...
### [23] [The Free Inference Dimension: Complexity Measure for Zero-Collision Navigation under Hypothesis Mixtures](https://arxiv.org/abs/2609.17816)
...
### [24] [NObSP: Functional Decomposition of Neural Networks via Oblique Subspace Projections](https://arxiv.org/abs/2609.17825)
...
### [25] [ASPIRE: Asynchronous Batched Self-Speculative Decoding for Long-Context LLM Inference](https://arxiv.org/abs/2609.17943)
...
### [26] [Procedural Pretraining for Molecular Property Prediction](https://arxiv.org/abs/2609.17831)
...
### [27] [Adaptive hybrid coupling with operator inference, the overlapping Schwarz alternating method and reinforcement learning](https://arxiv.org/abs/2609.17837)
...
### [28] [Hybrid coupling with numerics-informed neural networks and the overlapping Schwarz alternating method](https://arxiv.org/abs/2609.17841)
...
### [29] [Uncertainty-Aware Continual Learning for Open-World Intent Discovery Under an evolving Label Space](https://arxiv.org/abs/2609.17866)
...
### [30] [Dataset-Dependent Effects of Cross-Depth Aggregation and Soft-Routed Experts in EEG Foundation Model Fine-Tuning](https://arxiv.org/abs/2609.17886)
...
### [31] [Long-Context Demonstration Selection Using State Space Models](https://arxiv.org/abs/2609.17888)
...
### [32] [TabPFN-3.5: Technical Report](https://arxiv.org/abs/2609.17895)
...
### [33] [Walking the Score Manifold: Continuous-time Generative Dynamics on Learned Data Manifolds](https://arxiv.org/abs/2609.17901)
...
### [34] [EdgeReMIND: A Scalable, Top-Ranked Memorization Baseline for Temporal Multi-Relational Link Prediction](https://arxiv.org/abs/2609.17916)
*Bryant Pollard*
...
### [35] [Symmetry without a manifold: intrinsic dimension on orbits](https://arxiv.org/abs/2609.17926)
...
### [36] [Locating Hidden Failures Makes Long-Horizon Agents More Reliable](https://arxiv.org/abs/2609.17930)
...
### [37] [Beyond the Previous Layer: Residual Predictive Structure in Sparse MoE Routing](https://arxiv.org/abs/2609.17940)
...
### [38] [On the Identifiability of Mixed Ordinal and Exponential Family Causal DAGs under Linear Parametric Models](https://arxiv.org/abs/2609.17942)
...
### [39] [Maximum Strong Independent Sets in Hypergraphs: Reductions, Bounds, and Greedy Certificates](https://arxiv.org/abs/2609.17951)
...
### [40] [QuanText: Protecting Dataset-Level Secrets in Textual Data Sharing](https://arxiv.org/abs/2609.17995)
...
### [41] [The Attention Within: Consensus Dynamics in Selective State Space Models](https://arxiv.org/abs/2609.17997)
...
### [42] [Structural Inference under Hidden Agents](https://arxiv.org/abs/2609.18045)
...
### [43] [Regional Explanations via Causal Sufficiency and Necessity](https://arxiv.org/abs/2609.18049)
...
### [44] [Beyond Embedding Transfer: Component Roles in Grokking Transfer and Stability](https://arxiv.org/abs/2609.18078)
*Zeyu Jia*
...
### [45] [FedPGT: Progressive Gradient Transmission for Vehicular Federated Learning over Time-Varying Channels](https://arxiv.org/abs/2609.18089)
...
### [46] [Agora: Git as Shared Memory for Collective AutoResearch](https://arxiv.org/abs/2609.18094)
...
### [47] [iMINDBench: iEEG Multi-Institution Neural Decoding Benchmark](https://arxiv.org/abs/2609.18104)
...
### [48] [FoundAna: A GNN-assisted Foundation Model for Graph Anomaly Detection](https://arxiv.org/abs/2609.18107)
...
### [49] [Learning Fractional-Order Dynamics from a Single Trajectory](https://arxiv.org/abs/2609.18127)
...
### [50] [Colla-Q: Toward Collaborative Experts in MoE Quantization via Minimax Precision Balancing](https://arxiv.org/abs/2609.18131)
...
### [51] [Rethinking How We Evaluate Methodological Progress in Health AI](https://arxiv.org/abs/2609.18134)
...
### [52] [Reaching Every Position Without Searching: Rotating Sparse Wiring on the Hypercube as a Substitute for Attention](https://arxiv.org/abs/2609.18145)
*Yoshiaki Takashita*
...
### [53] [LIGE-GR: A Smooth Leap from Ranking to Generative Recommendation in the LLM Era](https://arxiv.org/abs/2609.18148)
...
### [111] [Computing Stationary Equilibria in Measure-Dependent Markov Systems](https://arxiv.org/abs/2609.17584)
...
### [112] [Decentralized Optimal Equilibrium Learning Over Dynamic Networks](https://arxiv.org/abs/2609.17601)
...
### [113] [Learning Market Competition in Shared Spectrum: A Multi-Agent Reinforcement Learning Approach](https://arxiv.org/abs/2609.17754)
...
### [114] [Estimate then Predict: Convex Formulation for Travel Demand Forecasting](https://arxiv.org/abs/2609.17919)
...
### [115] [Equilibria of Round-Robin: Computational Hardness and Fairness for Few Subadditive Agents](https://arxiv.org/abs/2609.18309)
...
### [116] [Second-Best Gains from Trade in Matching Markets](https://arxiv.org/abs/2609.18724)
...
### [117] [Core stability recognition for minimum-cost spanning tree games: Parameterized perspective](https://arxiv.org/abs/2609.18807)
...
### [118] [Epsilon-Nash Equilibria in History-Dependent SA-MDPs](https://arxiv.org/abs/2609.18829)
...
### [119] [On the Role of Tie-Breaking Rules in the Convergence of Fictitious Play for Symmetric First-Price Auctions](https://arxiv.org/abs/2609.18848)
*Benjamin Heymann*
...
### [120] [SpecReuse: Spectral Graph Reuse for Efficient Vision GNN Inference on FPGAs](https://arxiv.org/abs/2609.17718)
...
### [121] [Large Language Model based air quality monitoring and localized alert generation](https://arxiv.org/abs/2609.17954)
...
### [122] [Towards Training Private LLMs: Exploring Fine-Tuning Language Models on Apple Silicon with RDMA over Thunderbolt](https://arxiv.org/abs/2609.18066)
...
### [123] [SSD-LLaMA: SSD-Native Inference for Trillion-Parameter MoE at 1+ Token/s on a Consumer PC](https://arxiv.org/abs/2609.18110)
...
### [124] [Token Latency Fairness: Performance Isolation for Multi-Tenant LLM Serving](https://arxiv.org/abs/2609.18112)
...
### [125] [Zero-I/O Fault Recovery for Sharded Deep Learning via Dynamic Framework Dependency Rebinding](https://arxiv.org/abs/2609.18178)
...
### [126] [GeoMesh: Workload-Balanced and Sign-Compressed Geo-Distributed LLM Training](https://arxiv.org/abs/2609.18388)
...
### [127] [From Pixels to Semantics: Edge AI for UAV-Based Critical Infrastructure Inspection](https://arxiv.org/abs/2609.18448)
...
### [128] [DiverseFT: Diversifying Fault-Tolerant Systems using LLMs](https://arxiv.org/abs/2609.18512)
...
### [129] [COMPASS-ABS: Reducing Fragmentation in Shared GPU Clusters for Deep Learning Training Workloads](https://arxiv.org/abs/2609.18519)
...
### [130] [AUPE: Collaborative byzantine fault-tolerant peer-sampling](https://arxiv.org/abs/2609.18563)
...
### [131] [RayOrch: Programming and Executing Lineage-Controlled Multi-Grain Dataflows for Foundation-Model Data Preparation](https://arxiv.org/abs/2609.18703)
...
### [132] [Vigil: Accountable Liveness against Selective Silence](https://arxiv.org/abs/2609.18778)
...
### [133] [A Distributed Computing Framework for Satellite Swarms](https://arxiv.org/abs/2609.18839)
...
### [134] [Ask the Tool, Don't Guess: Agent Tool Calls Hold Their Progress, and the Serving System Should Read It](https://arxiv.org/abs/2609.18849)
...
### [135] [Fluid Notarization: Verifiable Evolution of Concurrently Edited Structured Documents](https://arxiv.org/abs/2609.18886)
...
### [136] [Ermes: a Stateful Serverless Platform for the Edge-to-Cloud Continuum](https://arxiv.org/abs/2609.18924)
...
### [137] [Replication-Aware Placement of Functions and Data in the Edge-Cloud Continuum](https://arxiv.org/abs/2609.18932)
...
### [138] [OAK: Restart- and Age-Aware Scheduling for Distributed Machine Learning on Shared GPU Clusters](https://arxiv.org/abs/2609.19024)
