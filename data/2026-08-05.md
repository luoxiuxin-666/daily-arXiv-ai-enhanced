...
### [9] [Deep Divide-and-Reduce in Symbolic Regression](https://arxiv.org/abs/2608.02628)
...
### [10] [Multimodal Auto-regressive Transformer Surrogate for Modeling Variable Operations and Quantifying Uncertainty in Geological Carbon Storage](https://arxiv.org/abs/2608.02629)
...
### [11] [LLMs Can Annotate Attribution Graphs](https://arxiv.org/abs/2608.02632)
...
### [12] [GeoID-PINN: Identifiability-Aware Regional Epidemic Inference with Geographic Coupling](https://arxiv.org/abs/2608.02633)
*Weixiong Hua,Fan Bu*
...
### [13] [Verifier-Guided Model Discovery for Physical Dynamical Systems with Pretrained Symbolic Transformers](https://arxiv.org/abs/2608.02662)
...
### [14] [CT-HEG: A Bidirectional, Timestamp-Attributed Event Graph for ICU In-Hospital Mortality Prediction - An Architectural Ablation Study](https://arxiv.org/abs/2608.02663)
...
### [15] [FedCritic-MIMO: Communication-Efficient Serverless Federated Critic Learning for Massive-MIMO Resource Control in Open and Disaggregated 6G RANs](https://arxiv.org/abs/2608.03852)
...
### [16] [Sphere Retraction Normalizations](https://arxiv.org/abs/2608.02668)
...
### [17] [Learning Molecular Representations from Cellular Phenotypes with Structure Preservation](https://arxiv.org/abs/2608.02688)
...
### [18] [GLOBE: Trajectory-Aligned Gradient Matching with Structured SparseOptimization for Coreset Selection](https://arxiv.org/abs/2608.02690)
...
### [19] [Output-Aware Rotation for INT2 KV-Cache Quantization](https://arxiv.org/abs/2608.02691)
...
### [20] [PatTree: a novel approach for automated creation of multimodal, graph-based patient representations for medical classification tasks](https://arxiv.org/abs/2608.02692)
...
### [23] [AcceptMoE: Commitment-Weighted Self-Sizing Verifier Expert Sets for Efficient MoE Speculative Decoding](https://arxiv.org/abs/2608.02989)
...
### [24] [Can Training Logs Make Model Comparisons More Precise?](https://arxiv.org/abs/2608.02705)
*Wei-Jung Huang*
...
### [25] [FedCARE: A Multi-Objective Personalised Federated Learning Framework for Smart Healthcare](https://arxiv.org/abs/2608.03498)
...
### [26] [Designing a Good Virtual Node: Addressable and Cardinality-Preserving Global Memory for Message Passing Architectures](https://arxiv.org/abs/2608.02709)
*Félix Marcoccia*
...
### [27] [Resume Means Resume: A Machine-Checked Conformance Contract for Checkpoint, Interrupt, and Resume Semantics in Workflow Persistence Layers](https://arxiv.org/abs/2608.03836)
*Sajjad Khan*
...
### [28] [Neural Networks with Local Converging Inputs for Efficient Options Pricing Models](https://arxiv.org/abs/2608.02778)
...
### [29] [Evaluation Blindness: How Silent Measurement Failures Corrupt AI Systems from Training to Deployment](https://arxiv.org/abs/2608.02786)
*Priyanka Bajaj*
...
### [30] [Topological Simplification in Predictive Coding Networks](https://arxiv.org/abs/2608.02816)
...
### [31] [Wiring Beats Blending: What Transfers Between Transformer Sizes -- and What Doesn't](https://arxiv.org/abs/2608.02829)
...
### [32] [NOMADD: Numerical Optimization of Models Adapting to Data Drift](https://arxiv.org/abs/2608.02845)
...
### [33] [Adaptive Sampling for Automated Post-Disaster Rapid Damage Assessment via Level-Set Cost-Aware Bayesian Optimization](https://arxiv.org/abs/2608.02868)
...
### [34] [Contrast-invariant deep ptychography neural networks](https://arxiv.org/abs/2608.02869)
...
### [35] [Maglev: Sliding Recurrent Memory](https://arxiv.org/abs/2608.02870)
*Bo Liu,Qiang Liu*
...
### [36] [GoT-CD: Graph-of-Thoughts Causal Discovery and the Fragility of Post-hoc Path-Specific Fairness Audits](https://arxiv.org/abs/2608.02877)
...
### [37] [Population-Robust Feature Selection via Generalized Welfare Optimization](https://arxiv.org/abs/2608.02887)
...
### [38] [Robust Counterfactual Policy Optimisation via Nondeterministic Causal Models](https://arxiv.org/abs/2608.02893)
...
### [39] [AnchorKV: Anchor-Residual KV Cache Compression](https://arxiv.org/abs/2608.02901)
...
### [40] [Bayesian Data Reweighting Improves Multimodal Retrieval for Knowledge-Based Visual Question Answering](https://arxiv.org/abs/2608.02907)
...
### [41] [Forecasting Revenue with its Customer-Base Drivers: When and Why Coordination Helps](https://arxiv.org/abs/2608.02911)
...
### [42] [When Should Graph Attention Be Sparse? Learning a Per-Edge Tsallis Index](https://arxiv.org/abs/2608.02938)
...
### [43] [Federated generative event models for tokenized electronic health records](https://arxiv.org/abs/2608.02939)
...
### [44] [Sedentary Behavior Classification for Wearable Sensors with a CNN-BiLSTM Model](https://arxiv.org/abs/2608.02946)
...
### [45] [ATFlash: Per-RoPE-Wavelength Attention Windows for Compute/Memory-Efficient LLM Inference](https://arxiv.org/abs/2608.02947)
...
### [46] [Rubrics as Privileged Information for Open-Ended Generation](https://arxiv.org/abs/2608.02948)
...
### [47] [Schedule-Informed Temporal Fusion Forecasting of Hourly Airport Security-Checkpoint Throughput](https://arxiv.org/abs/2608.02950)
...
### [48] [SP3O: Reinforcement Learning from Segment Preferences without Reward Modeling](https://arxiv.org/abs/2608.02951)
...
### [49] [Inverted Detection and Control in Steering Vectors](https://arxiv.org/abs/2608.02957)
...
### [50] [Scaling an Autoregressive Transformer for Single-Cell Generation](https://arxiv.org/abs/2608.02961)
...
### [51] [A Physics-Informed Hybrid Neural Operator for Transient Magnetization Prediction in Power Magnetics](https://arxiv.org/abs/2608.02965)
...
### [52] [Temporal Leakage in LLM Backtesting: Measurement, Validation, and Adjusted Scores](https://arxiv.org/abs/2608.02985)
...
### [53] [Joint Affine Spectral Shaping: Coupling Weight and Bias Updates Beyond Weight-Only Muon](https://arxiv.org/abs/2608.02991)
...
### [54] [A Graph Signal Processing Perspective on Numerical Sequence Representations in LLM In-Context Learning](https://arxiv.org/abs/2608.03015)
...
### [55] [Paired Recipient-based Evaluation of Survival Prediction for Deceased Donor Kidney Transplants](https://arxiv.org/abs/2608.03017)
...
### [56] [PLAN: Parallel Liquid-Inspired Approximation Network for Efficient Representation Learning in Flexible Job Shop Scheduling](https://arxiv.org/abs/2608.03041)
...
### [57] [Exploiting Separability in Multi-Scale Grey-Box Bayesian Optimization](https://arxiv.org/abs/2608.03045)
...
### [58] [Revisiting TD Target Aggregation under Uncertainty in Q-Learning](https://arxiv.org/abs/2608.03069)
...
### [59] [SynEnergy: Anomaly Semantic-Guided Diffusion for Synthetic Energy Data Generation](https://arxiv.org/abs/2608.03087)
...
### [60] [SMOPD: Multi-Reward Reinforcement Learning via Specialize-and-Merge Online Policy Distillation](https://arxiv.org/abs/2608.03092)
...
### [61] [Convex-Hull-Neighborhood Smooth Dual Generalization: Controlling Local Correction Propagation in Offline RL](https://arxiv.org/abs/2608.03108)
...
### [62] [Double Descent in Gradient Boosting Decision Trees via Split-Candidate Scaling](https://arxiv.org/abs/2608.03111)
*Ryuichi Kanoh*
...
### [63] [Simulation-free and finite-time diffusion model](https://arxiv.org/abs/2608.03117)
...
### [64] [Trajectory-Guided Forget-Recover Network for Continual LLM Unlearning](https://arxiv.org/abs/2608.03123)
...
### [65] [Lightweight Chunk Selection for Mobile Retrieval-Augmented Generation](https://arxiv.org/abs/2608.03148)
...
### [66] [On the Implicit Flatness Bias of Sharpness-Aware Minimization: A Linear Stability Analysis with Quantitative Hyperparameter Bounds](https://arxiv.org/abs/2608.03197)
...
### [67] [Agentic Reinforcement Learning with Self-Distilled Reward Shaping](https://arxiv.org/abs/2608.03223)
...
### [68] [SAKI: Score-Aware Low-Rank Key Indexing for Long-Context KV Retrieval](https://arxiv.org/abs/2608.03228)
*Lin Zhang*
...
### [69] [FinVerse: Financial Time-Series Benchmark](https://arxiv.org/abs/2608.03259)
...
### [70] [ED-DiT: Physics-Guided Diffusion Pretraining for Transferable Molecular Representations from Electron Density](https://arxiv.org/abs/2608.03260)
...
### [71] [The Ignition Is Real, and It Lives at the Readout: Latent composition, difficulty-clocked ignition, and the interface-constituted commit in a recurrent-depth reasoner](https://arxiv.org/abs/2608.03263)
*Simon Lam-Muir*
...
### [72] [Noise-Aware Shrinkage for Differentially Private Zeroth-Order Fine-Tuning of Large Language Models](https://arxiv.org/abs/2608.03277)
...
### [73] [The Tell-Tale Trace: Detecting Reasoning Failures in LLMs Using Chain-of-Thought Dynamics](https://arxiv.org/abs/2608.03291)
...
### [74] [Provably Learning Multi-Head Attention with Queries](https://arxiv.org/abs/2608.03294)
...
### [76] [AS-FedBridge: Pseudo-Spike Bridge Distillation for Heterogeneous ANN-SNN Federated Learning](https://arxiv.org/abs/2608.03324)
...
### [77] [Tight Worst-Case Bounds for the Smallest Eigenvalue of ReLU NTK Gram Matrices](https://arxiv.org/abs/2608.03368)
*Zhao Song*
...
### [78] [Benign interpolation and Occam's razor](https://arxiv.org/abs/2608.03386)
...
### [79] [TimeRLM: Recursive Language Models Enable Precise Anomaly Localization in Long-Context Time-Series](https://arxiv.org/abs/2608.03391)
...
### [80] [Shorter Reasoning, Earlier Answers? An Evaluation of Reasoning Interfaces](https://arxiv.org/abs/2608.03401)
...
### [81] [Stop Replacing Noise with Noise: Two-Source Reliability Assessment for Label Correction and Sample Reweighting in Label-Noise Learning](https://arxiv.org/abs/2608.03432)
*Wenxiao Fan,Kan Li*
...
### [82] [Approximate Speculative Decoding](https://arxiv.org/abs/2608.03447)
...
### [83] [Beyond the Gegenbauer Paradigm: q-Orthogonal Kernels for Machine Learning](https://arxiv.org/abs/2608.03482)
...
### [85] [Pin Once, Swap Light: Subspace-Aligned Centroid-Residual Training for Efficient Ultra-LoRA Serving](https://arxiv.org/abs/2608.03579)
...
### [86] [Design-Time Optimization of Deep Neural Networks for Intermittent Learning on Microcontrollers](https://arxiv.org/abs/2608.03589)
...
### [87] [A Theory of Conditional Collapse under Low-Rank Weight-Space Ablations: I. The Single-Block Theory and Synthetic Validation](https://arxiv.org/abs/2608.03620)
*Abdallah Khemais*
...
### [88] [ConformalShift: Targeted Event Reordering Against Adaptive ECG Monitoring](https://arxiv.org/abs/2608.03628)
...
### [89] [POEM: Phase-Aware $\mathrm{SO}(2)$ Feature Rotation for Time Series Forecasting Under Periodicity Drift](https://arxiv.org/abs/2608.03630)
...
### [90] [CausalOPD: First-Wrong-Step Supervision for Distilling Causal Chain Reasoning](https://arxiv.org/abs/2608.03673)
...
### [91] [DiagLoop: A Counterfactual Data Flywheel with Stage-Localized Reinforcement for Diagnostic LLMs](https://arxiv.org/abs/2608.03674)
*Jian Zhang,Bingyi Wang,Yizhi Liu*
...
### [92] [LAEF: A Lead-Agnostic ECG Foundation Model Towards Point-of-Care Diagnostics](https://arxiv.org/abs/2608.03690)
...
### [93] [Learning and Clustering on Temporal Graphs: Principles, Primitives, and Pooling](https://arxiv.org/abs/2608.03696)
...
### [94] [To Describe or Construct Statistical Learning Models Using the Category-theoretical Language](https://arxiv.org/abs/2608.03706)
*Congwei Song*
...
### [95] [Amortized Interventional Forecasting for Multivariate CIR Processes](https://arxiv.org/abs/2608.03715)
...
### [96] [UNVaMP: Neural Knowledge Tracing with Variational Regularization of Latent Knowledge Dynamics](https://arxiv.org/abs/2608.03811)
...
### [97] [Quantization Effects on Biomedical LLM Reliability](https://arxiv.org/abs/2608.03854)
...
### [98] [Bi-semantic Chemical Embedder for Joint Representation Learning of SMILES and Natural Language](https://arxiv.org/abs/2608.03855)
...
### [99] [CRS-Triage: Confidence- and Reliability-Aware Selective Triage under Incomplete Clinical Evidence](https://arxiv.org/abs/2608.03862)
...
### [100] [GENESIS: Towards Explainable Causal Discovery](https://arxiv.org/abs/2608.03868)
...
### [101] [Enhancing VLM Reward Models Through Structure-Aware Fine-Tuning](https://arxiv.org/abs/2608.03875)
...
### [102] [Operationally Feasible Synthetic Power-Grid Scenarios via Learning the AC-Operable Joint Distribution](https://arxiv.org/abs/2608.03878)
...
### [103] [Omega-S: A Functional Resilience Index for LLM Fine-Tuning](https://arxiv.org/abs/2608.03887)
*Alberto Acedo*
...
### [104] [Cross-Model KV Cache Transfer in LLM Families: A Closed-Form Linear Mapping for Prefill Reuse](https://arxiv.org/abs/2608.03893)
...
### [105] [Sparse Weight Decomposition for Efficient Circuit Extraction](https://arxiv.org/abs/2608.03913)
...
### [106] [Trajectory inference via Acceleration Matching](https://arxiv.org/abs/2608.03916)
...
### [107] [PRISM: Powerful Time Series to Image (TS2I) Representations for Multivariate Anomaly Detection](https://arxiv.org/abs/2608.03926)
...
### [108] [A Physics-Flavored Transformer Network for Parametrizing Contraction Dynamics of Engineered Skeletal Muscle Tissues](https://arxiv.org/abs/2608.03927)
...
### [109] [Latent Reward Registers for Diffusion Preference Alignment](https://arxiv.org/abs/2608.03929)
...
### [110] [Muon Meets Mamba: Spectral Optimization for State Space Models](https://arxiv.org/abs/2608.03941)
...
### [111] [Assessment of Conditional Diffusion Model for Synthetic Histopathology Image Generation](https://arxiv.org/abs/2608.03990)
...
### [112] [Test-Time Scaling in Reasoning LLMs: Inference Regimes, Evaluation, and Reproducibility](https://arxiv.org/abs/2608.04001)
...
### [113] [Quota and population monotonicity across house sizes are incompatible for apportionment to four states](https://arxiv.org/abs/2608.02759)
*Lav R. Varshney*
...
### [114] [EFX Allocation In (Multi)Hypergraphs](https://arxiv.org/abs/2608.03171)
...
### [115] [3 Players Auction Bridge - Statistical Algorithmic Strategies](https://arxiv.org/abs/2608.03217)
...
### [116] [Separating Intelligence from Inference: A Standard for Edge-Native AI Computing](https://arxiv.org/abs/2608.02608)
...
### [117] [KernelBrain: Coarse-to-Fine, Budget-Aware Search for Agentic GPU Kernel Optimization](https://arxiv.org/abs/2608.02611)
*Shuai Che,Gang Peng*
...
### [118] [Axiomatic shared-medium coordination for stigmergic systems](https://arxiv.org/abs/2608.02619)
...
### [119] [Configurable and Hierarchical Allreduce](https://arxiv.org/abs/2608.02884)
...
### [120] [Distributed Algorithms for Near-Equitable Coloring](https://arxiv.org/abs/2608.02910)
...
### [121] [Diameter-Free Distributed Frequency Control for Graph Coloring in the CONGEST Model](https://arxiv.org/abs/2608.02920)
*Amit Nir,David Peleg*
...
### [122] [Pruning-Aware Multi-Cluster Co-Inference for Large AI Models in AI-RANs](https://arxiv.org/abs/2608.03026)
...
### [123] [Trust-Aware Topology Learning for Dynamic Decentralized Federated Learning under Adversaries](https://arxiv.org/abs/2608.03156)
...
### [124] [LPV Control for Dynamic Power Capping in High-Performance Computing under Mixed Workloads](https://arxiv.org/abs/2608.03367)
...
### [125] [FedRings: A Scalable and Topology-Aware Federated Learning Framework for LEO Satellite Constellations](https://arxiv.org/abs/2608.03436)
...
### [126] [TAOT: Topology-Aware Optimal Transport for Dynamic Expert Replica Placement in MoE Training](https://arxiv.org/abs/2608.03676)
...
### [127] [Accelerating Dynamic Graph Clustering on GPU Architectures with cuGraph](https://arxiv.org/abs/2608.03695)
*Nelson Aloysio Reis de Almeida Passos,Emanuele Carlini,Salvatore Trani*
...
### [128] [When Does Disaggregation Pay? Simulating Prefill--Decode--Attention--FFN Specialization for Agentic LLM Inference](https://arxiv.org/abs/2608.03741)
