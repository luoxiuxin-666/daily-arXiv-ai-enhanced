...
### [1] [Strategically Robust Aggregative Games](https://arxiv.org/abs/2604.23669)
...
### [2] [Learning is Revelation in Disguise: Improved Regret and Equivalence Results for Dynamic Pricing](https://arxiv.org/abs/2604.24093)
*Shiliang Zuo*
...
### [3] [Strategic Bidding in 6G Spectrum Auctions with Large Language Models](https://arxiv.org/abs/2604.24156)
...
### [4] [Explanation Systems for Approval-Based Multiwinner Voting](https://arxiv.org/abs/2604.24307)
...
### [5] [Private Private Information in Second-Price Auction](https://arxiv.org/abs/2604.24530)
...
### [6] [Verification of Correlated Equilibria in Concurrent Reachability Games](https://arxiv.org/abs/2604.24655)
...
### [7] [Distributional Robustness of Linear Contracts](https://arxiv.org/abs/2604.24732)
*Shiliang Zuo*
...
### [8] [A Strongly Polynomial Algorithm for Arctic Auctions](https://arxiv.org/abs/2604.24756)
...
### [9] [Network Edge Inference for Large Language Models: Principles, Techniques, and Opportunities](https://arxiv.org/abs/2604.22906)
...
### [10] [GreenDyGNN: Runtime-Adaptive Energy-Efficient Communication for Distributed GNN Training](https://arxiv.org/abs/2604.23139)
...
### [11] [The Blockchain Execution Dilemma: Optimizing Revenue XOR Fair Ordering](https://arxiv.org/abs/2604.23266)
...
### [12] [A Taxonomy and Resolution Strategy for Client-Level Disagreements in Federated Learning](https://arxiv.org/abs/2604.23386)
...
### [13] [ClusterFusion++: Expanding Cluster-Level Fusion to Full Transformer-Block Decoding](https://arxiv.org/abs/2604.23553)
...
### [14] [Towards System-Oriented Formal Verification of Local-First Access Control](https://arxiv.org/abs/2604.23560)
...
### [15] [SDSL-Solver: Scalable Distributed Sparse Linear Solvers for Large-Scale Interior Point Methods](https://arxiv.org/abs/2604.23979)
...
### [16] [KubePACS: Kubernetes Cluster Using Performant, Highly Available, and Cost Efficient Spot Instances](https://arxiv.org/abs/2604.24027)
...
### [17] [TACO: Efficient Communication Compression of Intermediate Tensors for Scalable Tensor-Parallel LLM Training](https://arxiv.org/abs/2604.24088)
...
### [18] [Unfolding an Atomistic World: Atomistic Simulation of Reactor Pressure Vessel Steel Across Year-and-Meter Scales](https://arxiv.org/abs/2604.24091)
...
### [19] [Exact, Efficient, and Reliable Multi-Objective and Multi-Constrained IoT Workflow Scheduling in Edge-Hub-Cloud Cyber-Physical Systems](https://arxiv.org/abs/2604.24340)
...
### [20] [Incisor: Ex Ante Cloud Instance Selection for HPC Jobs](https://arxiv.org/abs/2604.24464)
...
### [21] [SpotVista: Availability-Aware Recommendation System for Reliable and Cost-Efficient Multi-Node Spot Instances](https://arxiv.org/abs/2604.24548)
...
### [22] [Complete Cyclic Subtask Graphs for Tool-Using LLM Agents: Flexibility, Cost, and Bottlenecks in Multi-Agent Workflows](https://arxiv.org/abs/2604.22820)
...
### [23] [Beyond Single-Agent Alignment: Preventing Context-Fragmented Violations in Multi-Agent Systems](https://arxiv.org/abs/2604.22879)
*Jie Wu,Ming Gong*
...
### [24] [Usable Agent Discovery for Decentralized AI Systems](https://arxiv.org/abs/2604.23080)
...
### [25] [Architecture Matters for Multi-Agent Security](https://arxiv.org/abs/2604.23459)
...
### [26] [DLM: Unified Decision Language Models for Offline Multi-Agent Sequential Decision Making](https://arxiv.org/abs/2604.23557)
...
### [27] [EndoGov: A knowledge-governed multi-agent expert system for endometrial cancer risk stratification](https://arxiv.org/abs/2604.23802)
...
### [28] [The Spectral Lifecycle of Transformer Training: Transient Compression Waves, Persistent Spectral Gradients, and the Q/K--V Asymmetry](https://arxiv.org/abs/2604.22778)
*Yi Liu*
...
### [29] [KARL: Mitigating Hallucinations in LLMs via Knowledge-Boundary-Aware Reinforcement Learning](https://arxiv.org/abs/2604.22779)
...
### [30] [BiTA: Bidirectional Gated Recurrent Unit-Transformer Aggregator in a Temporal Graph Network Framework for Alert Prediction in Computer Networks](https://arxiv.org/abs/2604.22781)
...
### [31] [Stochastic KV Routing: Enabling Adaptive Depth-Wise Cache Sharing](https://arxiv.org/abs/2604.22782)
...
### [32] [Parameter Efficiency Is Not Memory Efficiency: Rethinking Fine-Tuning for On-Device LLM Adaptation](https://arxiv.org/abs/2604.22783)
...
### [33] [Learning Without Adversarial Training: A Physics-Informed Neural Network for Secure Power System State Estimation under False Data Injection Attacks](https://arxiv.org/abs/2604.22784)
...
### [34] [CoFi-PGMA: Counterfactual Policy Gradients under Filtered Feedback for Multi-Agent LLMs](https://arxiv.org/abs/2604.22785)
...
### [35] [AutoCompress: Critical Layer Isolation for Efficient Transformer Compression](https://arxiv.org/abs/2604.22786)
*Archit Thorat*
...
### [36] [Prior-Agnostic Robust Forecast Aggregation](https://arxiv.org/abs/2604.24517)
...
### [37] [Conformal PM2.5 Mapping Under Spatial Covariate Shift: Satellite-Reanalysis Fusion for Africa's Green Industrial Transition](https://arxiv.org/abs/2604.22787)
...
### [38] [Avionic Main Fuel Pump Simulation and Fault-Diagnosis Benchmark](https://arxiv.org/abs/2604.22869)
...
### [39] [Towards Understanding the Expressive Power of GNNs with Global Readout](https://arxiv.org/abs/2604.22870)
...
### [40] [FlashOverlap: Minimizing Tail Latency in Communication Overlap for Distributed LLM Training](https://arxiv.org/abs/2604.24013)
...
### [41] [When Policies Cannot Be Retrained: A Unified Closed-Form View of Post-Training Steering in Offline Reinforcement Learning](https://arxiv.org/abs/2604.22873)
...
### [42] [MTServe: Efficient Serving for Generative Recommendation Models with Hierarchical Caches](https://arxiv.org/abs/2604.22881)
...
### [43] [Predicting Wind Loads on Container Ships in Harbor Environments through Multi-Fidelity Modeling](https://arxiv.org/abs/2604.22882)
...
### [44] [Quantifying and Mitigating Self-Preference Bias of LLM Judges](https://arxiv.org/abs/2604.22891)
...
### [45] [StackFeat RL: Reinforcement Learning over Iterative Dual Criterion Feature Selection for Stable Biomarker Discovery](https://arxiv.org/abs/2604.22892)
...
### [46] [Utility-Aware Data Pricing: Token-Level Quality and Empirical Training Gain for LLMs](https://arxiv.org/abs/2604.22893)
...
### [48] [Deep Clustering for Climate: Analyzing Teleconnections through Learned Categorical States](https://arxiv.org/abs/2604.22909)
...
### [49] [Score-Repellent Monte Carlo: Toward Efficient Non-Markovian Sampler with Constant Memory in General State Spaces](https://arxiv.org/abs/2604.22948)
...
### [50] [Reward Models Are Secretly Value Functions: Temporally Coherent Reward Modeling](https://arxiv.org/abs/2604.22981)
*Alex Nikulkov*
...
### [51] [Collocation-based Robust Physics Informed Neural Networks for time-dependent simulations of pollution propagation under thermal inversion conditions on Spitsbergen](https://arxiv.org/abs/2604.23003)
...
### [52] [On-Device Vision Training, Deployment, and Inference on a Thumb-Sized Microcontroller](https://arxiv.org/abs/2604.23012)
*Jeremy Ellis*
...
### [53] [Complex SGD and Directional Bias in Reproducing Kernel Hilbert Spaces](https://arxiv.org/abs/2604.23017)
...
### [54] [Preserving Long-Tailed Expert Information in Mixture-of-Experts Tuning](https://arxiv.org/abs/2604.23036)
...
### [55] [A Differentiable Framework for Global Circulation Model Precipitation Bias Correction](https://arxiv.org/abs/2604.23045)
...
### [56] [Shape of Memory: a Geometric Analysis of Machine Unlearning in Second-Order Optimizers](https://arxiv.org/abs/2604.23046)
*Kennon Stewart*
...
### [57] [ML-Guided Primal Heuristics for Mixed Binary Quadratic Programs](https://arxiv.org/abs/2604.23053)
...
### [58] [K-Score: Kalman Filter as a Principled Alternative to Reward Normalization in Reinforcement Learning](https://arxiv.org/abs/2604.23056)
...
### [59] [C-MORAL: Controllable Multi-Objective Molecular Optimization with Reinforcement Alignment for LLMs](https://arxiv.org/abs/2604.23061)
...
### [60] [RL Token: Bootstrapping Online RL with Vision-Language-Action Models](https://arxiv.org/abs/2604.23073)
...
### [61] [Channel Adaptation for EEG Foundation Models: A Systematic Benchmark Across Architectures, Tasks, and Training Regimes](https://arxiv.org/abs/2604.23091)
...
### [62] [ProEval: Proactive Failure Discovery and Efficient Performance Estimation for Generative AI Evaluation](https://arxiv.org/abs/2604.23099)
...
### [63] [Unstable Rankings in Bayesian Deep Learning Evaluation](https://arxiv.org/abs/2604.23102)
...
### [64] [Conditional Imputation for Within-Modality Missingness in Multi-Modal Federated Learning](https://arxiv.org/abs/2604.23112)
...
### [65] [A Tale of Two Variances: When Single-Seed Benchmarks Fail in Bayesian Deep Learning](https://arxiv.org/abs/2604.23114)
...
### [66] [HBGSA: Hydrogen Bond Graph with Self-Attention for Drug-Target Binding Affinity Prediction](https://arxiv.org/abs/2604.23115)
...
### [67] [h-MINT: Modeling Pocket-Ligand Binding with Hierarchical Molecular Interaction Network](https://arxiv.org/abs/2604.23134)
...
### [68] [Surface Sensitivity in Lean 4 Autoformalization](https://arxiv.org/abs/2604.23135)
...
### [69] [Scaling Multi-Node Mixture-of-Experts Inference Using Expert Activation Patterns](https://arxiv.org/abs/2604.23150)
...
### [70] [Efficient VQ-QAT and Mixed Vector/Linear quantized Neural Networks](https://arxiv.org/abs/2604.23172)
...
### [71] [Follow the TRACE: Exploiting Post-Click Trajectories for Online Delayed Conversion Rate Prediction](https://arxiv.org/abs/2604.23197)
...
### [72] [A Layer Separation Optimization Framework for Cross-Entropy Training in Deep Learning](https://arxiv.org/abs/2604.23225)
...
### [73] [Contrastive Learning for Multimodal Human Activity Recognition with Limited Labeled Data](https://arxiv.org/abs/2604.23281)
...
### [74] [Revisable by Design: A Theory of Streaming LLM Agent Execution](https://arxiv.org/abs/2604.23283)
...
### [75] [An Analysis of Active Learning Algorithms using Real-World Crowd-sourced Text Annotations](https://arxiv.org/abs/2604.23290)
...
### [76] [CombiMOTS: Combinatorial Multi-Objective Tree Search for Dual-Target Molecule Generation](https://arxiv.org/abs/2604.23307)
...
### [77] [CODA: Coordination via On-Policy Diffusion for Multi-Agent Offline Reinforcement Learning](https://arxiv.org/abs/2604.23308)
...
### [78] [GIFT: Global stabilisation via Intrinsic Fine Tuning](https://arxiv.org/abs/2604.23312)
...
### [79] [Layer Embedding Deep Fusion Graph Neural Network](https://arxiv.org/abs/2604.23324)
...
### [80] [Process Supervision of Confidence Margin for Calibrated LLM Reasoning](https://arxiv.org/abs/2604.23333)
...
### [81] [TEMPO: Transformers for Temporal Disease Progression from Cross-Sectional Data](https://arxiv.org/abs/2604.23368)
...
### [82] [When Context Sticks: Studying Interference in In-Context Learning](https://arxiv.org/abs/2604.23371)
...
### [83] [V-GRPO: Online Reinforcement Learning for Denoising Generative Models Is Easier than You Think](https://arxiv.org/abs/2604.23380)
...
### [84] [Domain-Adapted Fine-Tuning of ECG Foundation Models for Multi-Label Structural Heart Disease Screening](https://arxiv.org/abs/2604.23385)
...
### [85] [Approximating Uniform Random Rotations by Two-Block Structured Hadamard Rotations in High Dimensions](https://arxiv.org/abs/2604.23418)
...
### [86] [Evolve: A Persistent Knowledge Lifecycle for Small Language Models](https://arxiv.org/abs/2604.23424)
*Dikran Hovagimian*
...
### [87] [When Does Removing LayerNorm Help? Activation Bounding as a Regime-Dependent Implicit Regularizer](https://arxiv.org/abs/2604.23434)
*Lucky Verma*
...
### [88] [Machine learning models for estimating counterfactuals in a single-arm inflammatory bowel disease study](https://arxiv.org/abs/2604.23465)
...
### [89] [Evaluating CUDA Tile for AI Workloads on Hopper and Blackwell GPUs](https://arxiv.org/abs/2604.23466)
...
### [90] [Hybrid JIT-CUDA Graph Optimization for Low-Latency Large Language Model Inference](https://arxiv.org/abs/2604.23467)
...
### [91] [GeoCert: Certified Geometric AI for Reliable Forecasting](https://arxiv.org/abs/2604.23474)
...
### [92] [Supernodes and Halos: Loss-Critical Hubs in LLM Feed-Forward Layers](https://arxiv.org/abs/2604.23475)
...
### [93] [Do Synthetic Trajectories Reflect Real Reward Hacking? A Systematic Study on Monitoring In-the-Wild Hacking in Code Generation](https://arxiv.org/abs/2604.23488)
...
### [94] [Interpretable Physics-Informed Load Forecasting for U.S. Grid Resilience: SHAP-Guided Ensemble Validation in Hybrid Deep Learning Under Extreme Weather](https://arxiv.org/abs/2604.23500)
...
### [95] [Autocorrelation Reintroduces Spectral Bias in KANs for Time Series Forecasting](https://arxiv.org/abs/2604.23518)
...
### [96] [When PINNs Go Wrong: Pseudo-Time Stepping Against Spurious Solutions](https://arxiv.org/abs/2604.23528)
...
### [97] [On the Memorization of Consistency Distillation for Diffusion Models](https://arxiv.org/abs/2604.23552)
...
### [98] [CAPSULE: Control-Theoretic Action Perturbations for Safe Uncertainty-Aware Reinforcement Learning](https://arxiv.org/abs/2604.23576)
...
### [99] [Hamiltonian Graph Inference Networks: Joint structure discovery and dynamics prediction for lattice Hamiltonian systems from trajectory data](https://arxiv.org/abs/2604.23606)
...
### [100] [Rank, Head-Channel Non-Identifiability, and Symmetry Breaking: A Precise Analysis of Representational Collapse in Transformers](https://arxiv.org/abs/2604.23681)
...
### [101] [Can an MLP Absorb Its Own Skip Connection?](https://arxiv.org/abs/2604.23705)
...
### [102] [OptProver: Bridging Olympiad and Optimization through Continual Training in Formal Theorem Proving](https://arxiv.org/abs/2604.23712)
...
### [103] [Quasi-Equivariant Metanetworks](https://arxiv.org/abs/2604.23720)
...
### [104] [Impact of Age Specialized Models for Hypoglycemia Classification](https://arxiv.org/abs/2604.23732)
...
### [105] [Transformer as an Euler Discretization of Score-based Variational Flow](https://arxiv.org/abs/2604.23740)
*Huadong Liao*
...
### [106] [SFT-then-RL Outperforms Mixed-Policy Methods for LLM Reasoning](https://arxiv.org/abs/2604.23747)
...
### [107] [The Override Gap: A Magnitude Account of Knowledge Conflict Failure in Hypernetwork-Based Instant LLM Adaptation](https://arxiv.org/abs/2604.23750)
...
### [108] [Agentic Fusion of Large Atomic and Language Models to Accelerate Materials Discovery](https://arxiv.org/abs/2604.23758)
...
### [109] [Necessary and sufficient conditions for universality of Kolmogorov-Arnold networks](https://arxiv.org/abs/2604.23765)
*Vugar Ismailov*
...
### [110] [WISE-FM:Operation-Aware, Engineering-Informed Foundation Model for Multi-Task Well Design](https://arxiv.org/abs/2604.23767)
...
### [111] [A General Representation-Based Approach to Multi-Source Domain Adaptation](https://arxiv.org/abs/2604.23790)
...
### [112] [ELSA: Exact Linear-Scan Attention for Fast and Memory-Light Vision Transformers](https://arxiv.org/abs/2604.23798)
...
### [113] [Causal Representation Learning from General Environments under Nonparametric Mixing](https://arxiv.org/abs/2604.23800)
...
### [114] [Reparameterization through Coverings and Topological Weight Priors](https://arxiv.org/abs/2604.23804)
...
### [115] [Symmetric Equilibrium Propagation for Thermodynamic Diffusion Training](https://arxiv.org/abs/2604.23806)
*Aditi De*
...
### [116] [JigsawRL: Assembling RL Pipelines for Efficient LLM Post-Training](https://arxiv.org/abs/2604.23838)
...
### [117] [Scalable Production Scheduling: Linear Complexity via Unified Homogeneous Graphs](https://arxiv.org/abs/2604.23841)
...
### [118] [Graph Memory Transformer (GMT)](https://arxiv.org/abs/2604.23862)
...
### [119] [Inverting Foundation Models of Brain Function with Simulation-Based Inference](https://arxiv.org/abs/2604.23865)
...
### [120] [Learning Interpretable PDE Representations for Generative Reconstructions with Structured Sparsity](https://arxiv.org/abs/2604.23867)
...
### [121] [Cardiac Stability Theory: An Axiomatically Grounded Framework for Continuous Cardiac Health Monitoring via Smartphone Photoplethysmography](https://arxiv.org/abs/2604.23876)
...
### [122] [Geometry Preserving Loss Functions Promote Improved Adaptation of Blackbox Generative Model](https://arxiv.org/abs/2604.23888)
...
### [123] [Machine Learning and Deep Learning Models for Short Term Electricity Price Forecasting in Australia's National Electricity Market](https://arxiv.org/abs/2604.23908)
...
### [124] [Gromov-Wasserstein Methods for Multi-View Relational Embedding and Clustering](https://arxiv.org/abs/2604.23912)
...
### [125] [Crystal structure prediction using graph neural combinatorial optimization](https://arxiv.org/abs/2604.23921)
...
### [126] [Robust and Clinically Reliable EEG Biomarkers: A Cross Population Framework for Generalizable Parkinson's Disease Detection](https://arxiv.org/abs/2604.23933)
...
### [127] [Task-guided Spatiotemporal Network with Diffusion Augmentation for EEG-based Dementia Diagnosis and MMSE Prediction](https://arxiv.org/abs/2604.23964)
...
### [128] [DecompKAN: Decomposed Patch-KAN for Long-Term Time Series Forecasting](https://arxiv.org/abs/2604.23968)
*Naveen Mysore*
...
### [129] [Continual Calibration: Coverage Can Collapse Before Accuracy in Lifelong LLM Fine-Tuning](https://arxiv.org/abs/2604.23987)
...
### [130] [Hindsight Preference Optimization for Financial Time Series Advisory](https://arxiv.org/abs/2604.23988)
...
### [131] [Fix Initial Codes and Iteratively Refine Textual Directions Toward Safe Multi-Turn Code Correction](https://arxiv.org/abs/2604.23989)
...
### [132] [When to Commit? Towards Variable-Size Self-Contained Blocks for Discrete Diffusion Language Models](https://arxiv.org/abs/2604.23994)
...
### [133] [TCOD: Exploring Temporal Curriculum in On-Policy Distillation for Multi-turn Autonomous Agents](https://arxiv.org/abs/2604.24005)
...
### [134] [Coverage-Based Calibration for Post-Training Quantization via Weighted Set Cover over Outlier Channels](https://arxiv.org/abs/2604.24008)
*Ibne Farabi Shihab,Sanjeda Akter,Anuj Sharma*
...
### [135] [FedSLoP: Memory-Efficient Federated Learning with Low-Rank Gradient Projection](https://arxiv.org/abs/2604.24012)
...
### [136] [Geometry-Aware Offline-to-Online Learning in Linear Contextual Bandits](https://arxiv.org/abs/2604.24016)
...
### [137] [A Limit Theory of Foundation Models: A Mathematical Approach to Understanding Emergent Intelligence and Scaling Laws](https://arxiv.org/abs/2604.24037)
...
### [138] [AgenticCache: Cache-Driven Asynchronous Planning for Embodied AI Agents](https://arxiv.org/abs/2604.24039)
...
### [139] [End-to-End Learning for Partially-Observed Time Series with PyPOTS](https://arxiv.org/abs/2604.24041)
...
### [140] [Generalising maximum mean discrepancy: kernelised functional Bregman divergences](https://arxiv.org/abs/2604.24047)
...
### [141] [Explaining Temporal Graph Predictions With Shapley Values](https://arxiv.org/abs/2604.24078)
...
### [142] [Meta-Ensemble Learning with Diverse Data Splits for Improved Respiratory Sound Classification](https://arxiv.org/abs/2604.24096)
...
### [143] [Fed-DLoRA: Efficient Wireless Federated Learning with Dynamic Low-Rank Adaptation](https://arxiv.org/abs/2604.24103)
...
### [144] [Leveraging Human Feedback for Semantically-Relevant Skill Discovery](https://arxiv.org/abs/2604.24127)
...
### [145] [Machine-Learning-Based Classification of Radio Frequency Building Loss](https://arxiv.org/abs/2604.24143)
...
### [146] [Progressive Approximation in Deep Residual Networks: Theory and Validation](https://arxiv.org/abs/2604.24154)
...
### [147] [Meta-Aligner: Bidirectional Preference-Policy Optimization for Multi-Objective LLMs Alignment](https://arxiv.org/abs/2604.24178)
...
### [148] [CMGL: Confidence-guided Multi-omics Graph Learning for Cancer Subtype Classification](https://arxiv.org/abs/2604.24201)
...
### [149] [IMPA-Net: Meteorology-Aware Multi-Scale Attention and Dynamic Loss for Extreme Convective Radar Nowcasting](https://arxiv.org/abs/2604.24224)
...
### [150] [GeoEdit: Local Frames for Fast, Training-Free On-Manifold Editing in Diffusion Models](https://arxiv.org/abs/2604.24238)
...
### [151] [BitRL: Reinforcement Learning with 1-bit Quantized Language Models for Resource-Constrained Edge Deployment](https://arxiv.org/abs/2604.24273)
...
### [152] [Model-Free Inference of Investor Preferences: A Relative Entropy IRL Approach](https://arxiv.org/abs/2604.24280)
*Chen Xu*
...
### [153] [Latent-Hysteresis Graph ODEs: Modeling Coupled Topology-Feature Evolution via Continuous Phase Transitions](https://arxiv.org/abs/2604.24293)
...
### [154] [SolarTformer: A Transformer Based Deep Learning Approach for Short Term Solar Power Forecasting](https://arxiv.org/abs/2604.24306)
...
### [155] [Self-Abstraction Learning for Effective and Stable Training of Deep Neural Networks](https://arxiv.org/abs/2604.24313)
...
### [156] [Mitigating Error Amplification in Fast Adversarial Training](https://arxiv.org/abs/2604.24332)
...
### [157] [Perfecting Aircraft Maneuvers with Reinforcement Learning](https://arxiv.org/abs/2604.24338)
...
### [158] [Unveiling the Backdoor Mechanism Hidden Behind Catastrophic Overfitting in Fast Adversarial Training](https://arxiv.org/abs/2604.24350)
...
### [159] [Diffusion Templates: A Unified Plugin Framework for Controllable Diffusion](https://arxiv.org/abs/2604.24351)
...
### [160] [An Aircraft Upset Recovery System with Reinforcement Learning](https://arxiv.org/abs/2604.24355)
...
### [161] [DPRM: A Plug-in Doob h transform-induced Token-Ordering Module for Diffusion Language Models](https://arxiv.org/abs/2604.24357)
...
### [162] [SAGE: Sparse Adaptive Guidance for Dependency-Aware Tabular Data Generation](https://arxiv.org/abs/2604.24368)
...
### [163] [PathMoG: A Pathway-Centric Modular Graph Neural Network for Multi-Omics Survival Prediction](https://arxiv.org/abs/2604.24371)
...
### [164] [Complexity of Linear Regions in Self-supervised Deep ReLU Networks](https://arxiv.org/abs/2604.24393)
...
### [165] [An Automatic Ground Collision Avoidance System with Reinforcement Learning](https://arxiv.org/abs/2604.24403)
...
### [166] [Advancing Ligand-based Virtual Screening and Molecular Generation with Pretrained Molecular Embedding Distance](https://arxiv.org/abs/2604.24474)
...
### [167] [SceneSelect: Selective Learning for Trajectory Scene Classification and Expert Scheduling](https://arxiv.org/abs/2604.24514)
...
### [168] [A Reward-Free Viewpoint on Multi-Objective Reinforcement Learning](https://arxiv.org/abs/2604.24532)
...
### [169] [Stochastic simultaneous optimistic optimization](https://arxiv.org/abs/2604.24537)
...
### [170] [Dialysis Risk Prediction and Treatment Effect Estimation for AKI patients using Longitudinal Electronic Health Records](https://arxiv.org/abs/2604.24547)
...
### [171] [GradMAP: Gradient-Based Multi-Agent Proximal Learning for Grid-Edge Flexibility](https://arxiv.org/abs/2604.24549)
...
### [172] [Efficient learning by implicit exploration in bandit problems with side observations](https://arxiv.org/abs/2604.24555)
...
### [173] [Fraud Detection in Cryptocurrency Markets with Spatio-Temporal Graph Neural Networks](https://arxiv.org/abs/2604.24590)
...
### [174] [Uncovering Latent Patterns in Social Media Usage and Mental Health: A Clustering-Based Approach Using Unsupervised Machine Learning](https://arxiv.org/abs/2604.24611)
...
### [175] [Cortex-Inspired Continual Learning: Unsupervised Instantiation and Recovery of Functional Task Networks](https://arxiv.org/abs/2604.24637)
...
### [176] [The Last Human-Written Paper: Agent-Native Research Artifacts](https://arxiv.org/abs/2604.24658)
...
### [177] [A Functorial Formulation of Neighborhood Aggregating Deep Learning](https://arxiv.org/abs/2604.24672)
...
### [178] [Diffusion-Guided Feature Selection via Nishimori Temperature: Noise-Based Spectral Embedding](https://arxiv.org/abs/2604.24692)
...
### [179] [Scalable Hyperparameter-Divergent Ensemble Training with Automatic Learning Rate Exploration for Large Models](https://arxiv.org/abs/2604.24708)
...
### [180] [SpecRLBench: A Benchmark for Generalization in Specification-Guided Reinforcement Learning](https://arxiv.org/abs/2604.24729)
...
### [181] [Learning to Think from Multiple Thinkers](https://arxiv.org/abs/2604.24737)
...
### [182] [Conflict-Aware Harmonized Rotational Gradient for Multiscale Kinetic Regimes](https://arxiv.org/abs/2604.24745)
*Zhangyong Liang*
...
### [183] [The Optimal Sample Complexity of Multiclass and List Learning](https://arxiv.org/abs/2604.24749)
*Chirag Pabbaraju*
