...
### [11] [Dynamic Shapley Computation](https://arxiv.org/abs/2605.20620)
...
### [12] [GraphDiffMed: Knowledge-Constrained Differential Attention with Pharmacological Graph Priors for Medication Recommendation](https://arxiv.org/abs/2605.20188)
...
### [13] [TabPFN-MT: A Natively Multitask In-Context Learner for Tabular Data](https://arxiv.org/abs/2605.20234)
...
### [14] [Provably Learning Diffusion Models under the Manifold Hypothesis: Collapse and Refine](https://arxiv.org/abs/2605.20235)
...
### [15] [MagBridge-Battery: A Synthetic Bridge Dataset for Li-ion Magnetometry and State-of-Health Diagnostics](https://arxiv.org/abs/2605.20240)
...
### [16] [Geometry-Lite: Interpretable Safety Probing via Layer-Wise Margin Geometry](https://arxiv.org/abs/2605.20241)
...
### [17] [LEAP: A closed-loop framework for perovskite precursor additive discovery](https://arxiv.org/abs/2605.20242)
...
### [18] [GROW: Aligning GRPO with State-Action Modeling for Open-World VLM Agents](https://arxiv.org/abs/2605.20246)
...
### [19] [LOSCAR-SGD: Local SGD with Communication-Computation Overlap and Delay-Corrected Sparse Model Averaging](https://arxiv.org/abs/2605.20866)
...
### [20] [CP-MoE: Consistency-Preserving Mixture-of-Experts for Continual Learning](https://arxiv.org/abs/2605.20247)
...
### [21] [Graph Transductive Sharpening: Leveraging Unlabeled Predictions in Node Classification](https://arxiv.org/abs/2605.20248)
...
### [22] [Automated Kernel Discovery Towards Understanding High-dimensional Bayesian Optimization](https://arxiv.org/abs/2605.20249)
...
### [23] [Physics-informed convolutional neural networks for fluid flow through porous media](https://arxiv.org/abs/2605.20250)
...
### [24] [Multi-Agent Reinforcement Learning for Safe Autonomous Driving Under Pedestrian Behavioral Uncertainty](https://arxiv.org/abs/2605.20255)
...
### [25] [FBOS-RL: Feedback-Driven Bi-Objective Synergistic Reinforcement Learning](https://arxiv.org/abs/2605.20256)
...
### [26] [Instance Discrimination for Link Prediction](https://arxiv.org/abs/2605.20257)
...
### [27] [It Takes Two: Complementary Self-Distillation for Contextual Integrity in LLMs](https://arxiv.org/abs/2605.20258)
...
### [28] [Residual Paving: Diagnosing the Routing Bottleneck in Selective Refusal Editing](https://arxiv.org/abs/2605.20262)
...
### [29] [Chronicle: A Multimodal Foundation Model for Joint Language and Time Series Understanding](https://arxiv.org/abs/2605.20268)
...
### [30] [Catching a Moving Subspace: Low-Rank Bandits Beyond Stationarity](https://arxiv.org/abs/2605.20269)
...
### [31] [Conformal Selective Acting: Anytime-Valid Risk Control for RLVR-Trained LLMs](https://arxiv.org/abs/2605.20270)
*Hamed Khosravi,Xiaoming Huo*
...
### [32] [Smaller Abstract State Spaces Enable Cross-Scale Generalization in Reinforcement Learning](https://arxiv.org/abs/2605.20272)
...
### [33] [Modality-Decoupled Online Recursive Editing](https://arxiv.org/abs/2605.20273)
...
### [34] [OmniISR: A Unified Framework for Centralized and Federated Learning via Intermediate Supervision and Regularization](https://arxiv.org/abs/2605.20276)
...
### [35] [ClaimDiff-RL: Fine-Grained Caption Reinforcement Learning through Visual Claim Comparison](https://arxiv.org/abs/2605.20278)
...
### [36] [Introspective X Training: Feedback Conditioning Improves Scaling Across all LLM Training Stages](https://arxiv.org/abs/2605.20285)
...
### [37] [FusionCell: Cross-Attentive Fusion of Layout Geometry and Netlist Topology for Standard-Cell Performance Prediction](https://arxiv.org/abs/2605.20287)
...
### [38] [Plug-and-Play Spiking Operators: Breaking the Nonlinearity Bottleneck in Spiking Transformers](https://arxiv.org/abs/2605.20289)
...
### [39] [Weasel: Out-of-Domain Generalization for Web Agents via Importance-Diversity Data Selection](https://arxiv.org/abs/2605.20291)
...
### [40] [TreeText-CTS: Compact, Source-Traceable Tree-Path Evidence for Irregular Clinical Time-Series Prediction](https://arxiv.org/abs/2605.20292)
...
### [41] [Closed-form predictive coding via hierarchical Gaussian filters](https://arxiv.org/abs/2605.20293)
...
### [42] [Quant.npu: Enabling Efficient Mobile NPU Inference for on-device LLMs via Fully Static Quantization](https://arxiv.org/abs/2605.20295)
...
### [43] [Spectral Unforgetting: Post-Hoc Recovery of Damaged Capabilities Without Retraining](https://arxiv.org/abs/2605.20296)
...
### [44] [Mechanisms of Misgeneralization in Physical Sequence Modeling](https://arxiv.org/abs/2605.20299)
...
### [45] [Robust Subspace-Constrained Quadratic Models for Low-Dimensional Structure Learning](https://arxiv.org/abs/2605.20300)
...
### [46] [Neural Collapse by Design: Learning Class Prototypes on the Hypersphere](https://arxiv.org/abs/2605.20302)
...
### [47] [AirfoilGen: A valid-by-construction and performance-aware latent diffusion model for airfoil generation](https://arxiv.org/abs/2605.20303)
...
### [48] [WaveGraphNet: Physics-Consistent Guided-Wave Damage Localization through Coupled Inverse-Forward Graph Learning](https://arxiv.org/abs/2605.20311)
...
### [49] [Less Data, Faster Training: repeating smaller datasets speeds up learning via sampling biases](https://arxiv.org/abs/2605.20314)
...
### [50] [Causal Unlearning in Collaborative Optimization: Exact and Approximate Influence Reversal under Adversarial Contributions](https://arxiv.org/abs/2605.20341)
...
### [51] [Symmetrization of Loss Functions for Robust Training of Neural Networks in the Presence of Noisy Labels](https://arxiv.org/abs/2605.20347)
...
### [52] [Consistently Informative Soft-Label Temperature for Knowledge Distillation](https://arxiv.org/abs/2605.20357)
...
### [53] [Nonlocal operator learning for fMRI encoding and decoding tasks](https://arxiv.org/abs/2605.20389)
...
### [54] [Score-Based Causal Discovery of Latent Variable Causal Models](https://arxiv.org/abs/2605.20396)
...
### [55] [Decomposing MXFP4 quantization error for LLM reinforcement learning: reducible bias, recoverable deadzone, and an irreducible floor](https://arxiv.org/abs/2605.20402)
...
### [56] [Spectral Souping: A Unified Framework for Online Preference Alignment](https://arxiv.org/abs/2605.20408)
...
### [57] [Supervised Latent Restructuring for Small-Data Quantum Learning in Plant Phenomics](https://arxiv.org/abs/2605.20413)
...
### [58] [Miller-Index-Based Latent Crystallographic Fracture Plane Reasoning with Vision-Language Models](https://arxiv.org/abs/2605.20416)
...
### [59] [Can Conversational XAI Improve User Performance? An Experimental Study](https://arxiv.org/abs/2605.20439)
...
### [60] [Group-Algebraic Tensors: Provably-optimal Equivariant Learning and Physical Symmetry Discovery](https://arxiv.org/abs/2605.20440)
...
### [61] [Weight Decay Regimes in Grokking Transformers: Cheap Online Diagnostics](https://arxiv.org/abs/2605.20441)
*Lucky Verma*
...
### [62] [LLM Pretraining Shapes a Generalizable Manifold: Insights into Cross-Modal Transfer to Time Series](https://arxiv.org/abs/2605.20449)
...
### [63] [CASCADE Conformal Prediction: Uncertainty-Adaptive Prediction Intervals for Two-Stage Clinical Decision Support](https://arxiv.org/abs/2605.20468)
...
### [64] [Training Language Agents to Learn from Experience](https://arxiv.org/abs/2605.20477)
...
### [65] [Quadratic Characterizations for Reachability Analysis of Neural Networks](https://arxiv.org/abs/2605.20482)
...
### [74] [Axiomatizing Neural Networks via Pursuit of Subspaces](https://arxiv.org/abs/2605.20534)
...
### [75] [OpenSeisML: Open Large-Scale Real Seismic and well-log Dataset for Generative AI](https://arxiv.org/abs/2605.20539)
...
### [76] [Latent Process Generator Matching](https://arxiv.org/abs/2605.20547)
...
### [77] [Complementing reinforcement learning with SFT through logit averaging in the post training of LLMs](https://arxiv.org/abs/2605.20555)
...
### [78] [Deep Learning Surrogates for Emulating Stochastic Climate Tipping Dynamics](https://arxiv.org/abs/2605.20580)
...
### [79] [TriForces: Augmenting Atomistic GNNs for Transferable Representations](https://arxiv.org/abs/2605.20581)
...
### [81] [Unsupervised clustering and classification of upper limb EMG signals during functional movements: a data-driven](https://arxiv.org/abs/2605.20599)
...
### [82] [Mechanistic Interpretability for Learning Assurance of a Vision-Based Landing System](https://arxiv.org/abs/2605.20607)
...
### [86] [The General Theory of Localization Methods](https://arxiv.org/abs/2605.20635)
*Congwei Song*
...
### [87] [Same Target, Different Basins: Hard vs. Soft Labels for Annotator Distributions](https://arxiv.org/abs/2605.20642)
...
### [88] [AVSD: Adaptive-View Self-Distillation by Balancing Consensus and Teacher-Specific Privileged Signals](https://arxiv.org/abs/2605.20643)
...
### [89] [Design for Manufacturing: A Manufacturability Knowledge-Integrated Reinforcement Learning Framework for Free-Form Pipe Routing in Aeroengines](https://arxiv.org/abs/2605.20644)
...
### [90] [LT2: Linear-Time Looped Transformers](https://arxiv.org/abs/2605.20670)
...
### [91] [Modular Multimodal Classification Without Fine-Tuning: A Simple Compositional Approach](https://arxiv.org/abs/2605.20674)
...
### [92] [Dynamic TMoE: A Drift-Aware Dynamic Mixture of Experts Framework for Non-Stationary Time Series Forecasting](https://arxiv.org/abs/2605.20678)
...
### [93] [Distributed Direct Preference Optimization](https://arxiv.org/abs/2605.20696)
*Zhanhong Jiang*
...
### [94] [Decision-Path Patterns as Tree Reliability Signals: Path-based Adaptive Weighting for Random Forest Classification](https://arxiv.org/abs/2605.20716)
*Youngjoon Park*
...
### [95] [Memory-Efficient Partitioned DNN Inference on Resource-Constrained Android Crowds](https://arxiv.org/abs/2605.20723)
...
### [96] [Hack-Verifiable Environments: Towards Evaluating Reward Hacking at Scale](https://arxiv.org/abs/2605.20744)
...
### [97] [The Hidden Signal of Verifier Strictness: Controlling and Improving Step-Wise Verification via Selective Latent Steering](https://arxiv.org/abs/2605.20745)
...
### [98] [The Devil is in the Condition Numbers: Why is GLU Better than non-GLU Structure?](https://arxiv.org/abs/2605.20749)
...
### [100] [ShapeBench: A Scalable Benchmark and Diagnostic Suite for Standardized Evaluation in Aerodynamic Shape Optimization](https://arxiv.org/abs/2605.20763)
...
### [101] [Cumulative Meta-Learning from Active Learning Queries for Robustness to Spurious Correlations](https://arxiv.org/abs/2605.20771)
...
### [102] [Learning to Think in Physics: Breaking Shortcut Learning in Scientific Diffusion via Representation Alignment](https://arxiv.org/abs/2605.20780)
...
### [103] [Causal Machine Learning Is Not a Panacea: A Roadmap for Observational Causal Inference in Health](https://arxiv.org/abs/2605.20782)
...
### [104] [Beyond Numerical Features: CNN-Driven Algorithm Selection via Contour Plots for Continuous Black-Box Optimization](https://arxiv.org/abs/2605.20797)
...
### [105] [Most Transformer Modifications Still Do Not Transfer at 1-3B: A 2020-2026 Update to Narang et al. (2021) with Downstream Evaluation and a Noise Floor](https://arxiv.org/abs/2605.20798)
...
### [107] [Markovian Circuit Tracing for Transformer State Dynamic](https://arxiv.org/abs/2605.20824)
*Abdullah X*
...
### [108] [Finite-Time Regret Analysis of Retry-Aware Bandits](https://arxiv.org/abs/2605.20854)
...
### [109] [Multi-Step Likelihood-Ratio Correction for Reinforcement Learning with Verifiable Rewards](https://arxiv.org/abs/2605.20865)
...
### [110] [Runtime-Certified Bounded-Error Quantized Attention](https://arxiv.org/abs/2605.20868)
*Dean Calver*
...
### [111] [CIG: Exploration via Conditional Information Gain](https://arxiv.org/abs/2605.20878)
...
### [112] [NeighborDiv: Training-free Zero-shot Generalist Graph Anomaly Detection via Neighbor Diversity](https://arxiv.org/abs/2605.20879)
...
### [113] [Learning fMRI activations dictionaries across individual geometries via optimal transport](https://arxiv.org/abs/2605.20883)
...
### [114] [Training distribution determines the ceiling of drug-blind cancer sensitivity prediction](https://arxiv.org/abs/2605.20885)
*Taekyung Heo*
...
### [115] [Winfree Oscillatory Neural Network](https://arxiv.org/abs/2605.20922)
*Jiawen Dai,Yue Song*
...
### [116] [DASH: Fast Differentiable Architecture Search for Hybrid Attention in Minutes on a Single GPU](https://arxiv.org/abs/2605.20936)
...
### [117] [A Deployment Audit of Release-Side Risk in Conformal Triage under Prevalence Shift](https://arxiv.org/abs/2605.20956)
...
### [118] [Choose Wisely and Privately: Proactive Client Selection for Fair and Efficient Federated Learning](https://arxiv.org/abs/2605.20975)
...
### [119] [Point Cloud Sequence Encoding for Material-conditioned Graph Network Simulators](https://arxiv.org/abs/2605.20978)
...
### [120] [A Sharper Picture of Generalization in Transformers](https://arxiv.org/abs/2605.20988)
...
### [121] [Modeling Temporal scRNA-seq Data with Latent Gaussian Process and Optimal Transport](https://arxiv.org/abs/2605.20989)
...
### [122] [Beyond the Bellman Recursion: A Pontryagin-Guided Framework for Non-Exponential Discounting](https://arxiv.org/abs/2605.20996)
...
### [123] [Efficient Banzhaf-Based Data Valuation for $k$-Nearest Neighbors Classification](https://arxiv.org/abs/2605.21033)
...
### [124] [A Dialogue between Causal and Traditional Representation Learning: Toward Mutual Benefits in a Unified Formulation](https://arxiv.org/abs/2605.21058)
...
### [125] [Divide et Calibra: Multiclass Local Calibration via Vector Quantization](https://arxiv.org/abs/2605.21060)
...
### [126] [Robust Personalized Recommendation under Hidden Confounding in MNAR](https://arxiv.org/abs/2605.21066)
...
### [127] [Towards Understanding Self-Pretraining for Sequence Classification](https://arxiv.org/abs/2605.21070)
...
### [128] [Reviving Error Correction in Modern Deep Time-Series Forecasting](https://arxiv.org/abs/2605.21088)
...
### [129] [UOTIP: Unbalanced Optimal Transport Map for Unpaired Inverse Problems](https://arxiv.org/abs/2605.21094)
...
### [130] [A Typed Tensor Language for Federated Learning](https://arxiv.org/abs/2605.21103)
...
### [131] [HORST: Composing Optimizer Geometries for Sparse Transformer Training](https://arxiv.org/abs/2605.21104)
...
### [132] [Improved Guarantees for Constrained Online Convex Optimization via Self-Contraction](https://arxiv.org/abs/2605.21107)
...
### [133] [A Unified Framework for Uncertainty-Aware Explainable Artificial Intelligence: A Case Study in Power Quality Disturbance Classification](https://arxiv.org/abs/2605.21114)
...
### [134] [Advantage Collapse in Group Relative Policy Optimization: Diagnosis and Mitigation](https://arxiv.org/abs/2605.21125)
...
### [135] [Reasoning-Trace Collapse: Evaluating the Loss of Explicit Reasoning During Fine-Tuning](https://arxiv.org/abs/2605.21127)
...
### [136] [Learning First Integrals via Backward-Generated Data and Guided Reinforcement Learning](https://arxiv.org/abs/2605.21160)
...
### [137] [ChunkFT: Byte-Streamed Optimization for Memory-Efficient Full Fine-Tuning](https://arxiv.org/abs/2605.21177)
...
### [142] [APEX: Autonomous Policy Exploration for Self-Evolving LLM Agents](https://arxiv.org/abs/2605.21240)
...
### [143] [Divide and Contrast: Learning Robust Temporal Features without Augmentation](https://arxiv.org/abs/2605.21241)
...
### [144] [Graph Navier Stokes Networks](https://arxiv.org/abs/2605.21247)
...
### [145] [On the Cost and Benefit of Chain of Thought: A Learning-Theoretic Perspective](https://arxiv.org/abs/2605.21260)
...
### [146] [Nonparametric Learning and Earning with One-Point Feedback under Nonstationarity](https://arxiv.org/abs/2605.21263)
...
### [147] [FedCoE: Bridging Generalization and Personalization via Federated Coordinated Dual-level MoEs](https://arxiv.org/abs/2605.21264)
...
### [148] [How Much Online RL is Enough? Informative Rollouts for Offline Preference Optimization in RLVR](https://arxiv.org/abs/2605.21266)
...
### [149] [A Mechanistic Study of Tabular Foundation Models](https://arxiv.org/abs/2605.21288)
...
### [150] [TimeSRL: Generalizable Time-Series Behavioral Modeling via Semantic RL-Tuned LLMs -- A Case Study in Mental Health](https://arxiv.org/abs/2605.21295)
...
### [151] [Automatic Discovery of Disease Subgroups by Contrasting with Healthy Controls](https://arxiv.org/abs/2605.21301)
...
### [152] [From Circuit Evidence to Mechanistic Theory: An Inductive Logic Approach](https://arxiv.org/abs/2605.21303)
...
### [153] [DeCoR: Design and Control Co-Optimization for Urban Streets Using Reinforcement Learning](https://arxiv.org/abs/2605.21311)
...
### [154] [A New Framework to Analyse the Distributional Robustness of Deep Neural Networks](https://arxiv.org/abs/2605.21313)
...
### [155] [CRAFT: Conflict-Resolved Aggregation for Federated Training](https://arxiv.org/abs/2605.21317)
...
### [156] [Optimized Federated Knowledge Distillation with Distributed Neural Architecture Search](https://arxiv.org/abs/2605.21322)
...
### [157] [Fast and Stable Triangular Inversion for Delta-Rule Linear Transformers](https://arxiv.org/abs/2605.21325)
...
### [159] [Classification of Single and Mixed Partial Discharges under Switching Voltage Using an AWA-CNN Framework](https://arxiv.org/abs/2605.21352)
...
### [160] [On the Regularity and Generalization of One-Step Wasserstein-guided Generative Models for PDE-Induced Measures](https://arxiv.org/abs/2605.21388)
...
### [163] [Adaptive Signal Resuscitation: Channel-wise Post-Pruning Repair for Sparse Vision Networks](https://arxiv.org/abs/2605.21426)
...
### [164] [Polynomial-Time Robust Multiclass Linear Classification under Gaussian Marginals](https://arxiv.org/abs/2605.21428)
...
### [165] [Gaussian Sheaf Neural Networks](https://arxiv.org/abs/2605.21435)
...
### [166] [torchtune: PyTorch native post-training library](https://arxiv.org/abs/2605.21442)
...
### [167] [Approximation Theory for Neural Networks: Old and New](https://arxiv.org/abs/2605.21451)
...
### [168] [Mitigating Label Bias with Interpretable Rubric Embeddings](https://arxiv.org/abs/2605.21455)
...
### [169] [A Machine Learning Framework for Weighted Least Squares GNSS Positioning based on Activation Functions](https://arxiv.org/abs/2605.21461)
...
### [170] [DelTA: Discriminative Token Credit Assignment for Reinforcement Learning from Verifiable Rewards](https://arxiv.org/abs/2605.21467)
...
### [171] [You Only Need Minimal RLVR Training: Extrapolating LLMs via Rank-1 Trajectories](https://arxiv.org/abs/2605.21468)
...
### [172] [Agent JIT Compilation for Latency-Optimizing Web Agent Planning and Scheduling](https://arxiv.org/abs/2605.21470)
...
### [173] [Is Fixing Schema Graphs Necessary? Full-Resolution Graph Structure Learning for Relational Deep Learning](https://arxiv.org/abs/2605.21475)
...
### [174] [EvoStruct: Bridging Evolutionary and Structural Priors for Antibody CDR Design via Protein Language Model Adaptation](https://arxiv.org/abs/2605.21485)
...
### [175] [Quantifying Hyperparameter Transfer and the Importance of Embedding Layer Learning Rate](https://arxiv.org/abs/2605.21486)
...
### [176] [Equilibrium Reasoners: Learning Attractors Enables Scalable Reasoning](https://arxiv.org/abs/2605.21488)
...
### [177] [Variance Reduction for Expectations with Diffusion Teachers](https://arxiv.org/abs/2605.21489)
...
### [178] [The Team Order Problem: Maximizing the Probability of Matching Being Large Enough](https://arxiv.org/abs/2605.21234)
...
### [179] [A Note on EFX Inapproximability for Chores](https://arxiv.org/abs/2605.21448)
...
### [180] [What Do Agents Communicate? Characterizing Information Exchange in Multi-Agent Systems](https://arxiv.org/abs/2605.20548)
...
### [181] [Multi-agent Collaboration with State Management](https://arxiv.org/abs/2605.20563)
...
### [182] [ProCrit: Self-Elicited Multi-Perspective Reasoning with Critic-Guided Revision for Multimodal Sarcasm Detection](https://arxiv.org/abs/2605.20867)
...
### [183] [Decoupling Communication from Policy: Robust MARL under Bandwidth Constraints](https://arxiv.org/abs/2605.21085)
