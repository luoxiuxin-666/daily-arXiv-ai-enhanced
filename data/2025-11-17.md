...
### [5] [Towards Assume-Guarantee Verification of Abilities in Stochastic Multi-Agent Systems](https://arxiv.org/abs/2511.10649)
...
### [7] [Exposing Weak Links in Multi-Agent Systems under Adversarial Prompting](https://arxiv.org/abs/2511.10949)
...
### [8] [Online Price Competition under Generalized Linear Demands](https://arxiv.org/abs/2511.10718)
...
### [9] [Optimal Welfare in Noncooperative Network Formation under Attack](https://arxiv.org/abs/2511.10845)
...
### [10] [Playing with Peaks: A Game-Theoretic Comparison of Electricity Pricing Mechanisms](https://arxiv.org/abs/2511.10854)
...
### [11] [Fair Incentives for Early Arrival in 0-1 Cooperative Games](https://arxiv.org/abs/2511.11023)
...
### [12] [ε-Optimally Solving Two-Player Zero-Sum POSGs](https://arxiv.org/abs/2511.11282)
...
### [13] [Computing Equilibrium Nominations in Presidential Elections](https://arxiv.org/abs/2511.11365)
...
### [14] [Nucleolus, Happy Nucleolus, and Vehicle Routing](https://arxiv.org/abs/2511.11371)
...
### [15] [Public Goods Games in Directed Networks with Constraints on Sharing](https://arxiv.org/abs/2511.11475)
...
### [16] [Deviation Dynamics in Cardinal Hedonic Games](https://arxiv.org/abs/2511.11531)
...
### [17] [Incremental Data-Driven Policy Synthesis via Game Abstractions](https://arxiv.org/abs/2511.11545)
...
### [18] [LAD-BNet: Lag-Aware Dual-Branch Networks for Real-Time Energy Forecasting on Edge Devices](https://arxiv.org/abs/2511.10680)
...
### [19] [EarthSight: A Distributed Framework for Low-Latency Satellite Intelligence](https://arxiv.org/abs/2511.10834)
...
### [20] [LT-Soups: Bridging Head and Tail Classes via Subsampled Model Soups](https://arxiv.org/abs/2511.10683)
...
### [22] [Differentiable Sparse Identification of Lagrangian Dynamics](https://arxiv.org/abs/2511.10706)
...
### [23] [SMART: A Surrogate Model for Predicting Application Runtime in Dragonfly Systems](https://arxiv.org/abs/2511.11111)
...
### [24] [Bias-Restrained Prefix Representation Finetuning for Mathematical Reasoning](https://arxiv.org/abs/2511.10707)
...
### [25] [A Unified Convergence Analysis for Semi-Decentralized Learning: Sampled-to-Sampled vs. Sampled-to-All Communication](https://arxiv.org/abs/2511.11560)
...
### [26] [Towards Uncertainty Quantification in Generative Model Learning](https://arxiv.org/abs/2511.10710)
...
### [27] [Movement-Specific Analysis for FIM Score Classification Using Spatio-Temporal Deep Learning](https://arxiv.org/abs/2511.10713)
...
### [28] [Fast Neural Tangent Kernel Alignment, Norm and Effective Rank via Trace Estimation](https://arxiv.org/abs/2511.10796)
*James Hazelden*
...
### [29] [Near-optimal Linear Predictive Clustering in Non-separable Spaces via Mixed Integer Programming and Quadratic Pseudo-Boolean Reductions](https://arxiv.org/abs/2511.10809)
...
### [30] [Transformers know more than they can tell -- Learning the Collatz sequence](https://arxiv.org/abs/2511.10811)
...
### [31] [Towards Universal Neural Operators through Multiphysics Pretraining](https://arxiv.org/abs/2511.10829)
...
### [32] [Benchmarking Quantum Kernels Across Diverse and Complex Data](https://arxiv.org/abs/2511.10831)
...
### [33] [SURFACEBENCH: Can Self-Evolving LLMs Find the Equations of 3D Scientific Surfaces?](https://arxiv.org/abs/2511.10833)
...
### [34] [The Map of Misbelief: Tracing Intrinsic and Extrinsic Hallucinations Through Attention Patterns](https://arxiv.org/abs/2511.10837)
...
### [39] [Private Zeroth-Order Optimization with Public Data](https://arxiv.org/abs/2511.10859)
*Xuchen Gong,Tian Li*
...
### [40] [Go-UT-Bench: A Fine-Tuning Dataset for LLM-Based Unit Test Generation in Go](https://arxiv.org/abs/2511.10868)
...
### [41] [Incorporating Spatial Information into Goal-Conditioned Hierarchical Reinforcement Learning via Graph Representations](https://arxiv.org/abs/2511.10872)
...
### [42] [Multi-Joint Physics-Informed Deep Learning Framework for Time-Efficient Inverse Dynamics](https://arxiv.org/abs/2511.10878)
...
### [43] [Graph Attention Network for Predicting Duration of Large-Scale Power Outages Induced by Natural Disasters](https://arxiv.org/abs/2511.10898)
...
### [53] [Improving Continual Learning of Knowledge Graph Embeddings via Informed Initialization](https://arxiv.org/abs/2511.11118)
...
### [54] [Anomaly Detection in High-Dimensional Bank Account Balances via Robust Methods](https://arxiv.org/abs/2511.11143)
...
### [55] [Deep Learning for Short-Term Precipitation Prediction in Four Major Indian Cities: A ConvLSTM Approach with Explainable AI](https://arxiv.org/abs/2511.11152)
...
### [56] [Adaptive Symmetrization of the KL Divergence](https://arxiv.org/abs/2511.11159)
...
### [57] [Training Neural Networks at Any Scale](https://arxiv.org/abs/2511.11163)
...
### [58] [Power Ensemble Aggregation for Improved Extreme Event AI Prediction](https://arxiv.org/abs/2511.11170)
...
### [59] [On-line learning of dynamic systems: sparse regression meets Kalman filtering](https://arxiv.org/abs/2511.11178)
...
### [60] [Dynamic Deep Graph Learning for Incomplete Multi-View Clustering with Masked Graph Reconstruction Loss](https://arxiv.org/abs/2511.11181)
...
### [61] [LoRaCompass: Robust Reinforcement Learning to Efficiently Search for a LoRa Tag](https://arxiv.org/abs/2511.11190)
...
### [62] [When to Stop Federated Learning: Zero-Shot Generation of Synthetic Validation Data with Generative AI for Early Stopping](https://arxiv.org/abs/2511.11208)
...
### [63] [A Best-of-Both-Worlds Proof for Tsallis-INF without Fenchel Conjugates](https://arxiv.org/abs/2511.11211)
...
### [73] [Robust inverse material design with physical guarantees using the Voigt-Reuss Net](https://arxiv.org/abs/2511.11388)
...
### [74] [SPOT: Single-Shot Positioning via Trainable Near-Field Rainbow Beamforming](https://arxiv.org/abs/2511.11391)
...
### [75] [Multi-Phase Spacecraft Trajectory Optimization via Transformer-Based Reinforcement Learning](https://arxiv.org/abs/2511.11402)
...
### [76] [Multicalibration yields better matchings](https://arxiv.org/abs/2511.11413)
...
### [87] [FarSkip-Collective: Unhobbling Blocking Communication in Mixture of Experts Models](https://arxiv.org/abs/2511.11505)
...
### [88] [Generalizing Fair Clustering to Multiple Groups: Algorithms and Applications](https://arxiv.org/abs/2511.11539)
...
### [89] [Multistability of Self-Attention Dynamics in Transformers](https://arxiv.org/abs/2511.11553)
*Claudio Altafini*
...
### [90] [Optimizing Mixture of Block Attention](https://arxiv.org/abs/2511.11571)
