...
### [1] [Symmetric solution of the Bellman optimality equation for repeated harmony game](https://arxiv.org/abs/2609.16289)
*Hisato Komatsu*
...
### [2] [Auction Design with ROI-Constrained Bidders: Truthfulness and Revenue Maximization](https://arxiv.org/abs/2609.16522)
...
### [3] [Anchored Sequential Deliberation](https://arxiv.org/abs/2609.16673)
...
### [4] [Constant Swap Regret in General-Sum Games via Optimistic Transition Matrices](https://arxiv.org/abs/2609.16751)
*Tung Mai*
...
### [5] [The price of anarchy in the max-distance network creation game is not constant](https://arxiv.org/abs/2609.17395)
*Christoph Schlegel*
...
### [6] [On testing the incentive compatibility of single-parameter allocation mechanisms](https://arxiv.org/abs/2609.17406)
...
### [7] ["Looking for Something Weird to Happen": How Humans Sustain AI Agent Novelty Amid Semantic Collapse](https://arxiv.org/abs/2609.16051)
...
### [8] [Cheap Talk Stabilizes Strategic Interaction in LLM Agents](https://arxiv.org/abs/2609.16270)
...
### [9] [Multi-Agent Learning with Cooperation-Driven Optimization Dynamics](https://arxiv.org/abs/2609.16917)
...
### [10] [ToMAS: A Pilot Failure-Grounded Theory-of-Mind Benchmark from Multi-Agent LLM Failures](https://arxiv.org/abs/2609.16986)
...
### [11] [BeWater: Effective Protesters Navigate Watersheds in Street Networks](https://arxiv.org/abs/2609.17017)
...
### [12] [Calibrate Once, Fly Any Team: Residual-Grounded Low-Fidelity Training for Cooperative Drone Swarms](https://arxiv.org/abs/2609.17265)
...
### [13] [Mo' Models, Mo' Problems: How to best select model pools when designing Multi-Agent Systems](https://arxiv.org/abs/2609.17306)
...
### [14] [Emergence World: Adversarial Stress-Testing of Long-Horizon Multi-Agent Systems](https://arxiv.org/abs/2609.17320)
...
### [15] [Decomposition Buys Integrity, Not Yield](https://arxiv.org/abs/2609.17464)
*Rong He*
...
### [16] [Agentic Societies Need a Social Harness](https://arxiv.org/abs/2609.17527)
...
### [17] [Causal neural set filtering for online multi-target tracking](https://arxiv.org/abs/2609.16054)
...
### [18] [Managing Action Preconditions in Neuro-Symbolic RL: Three Placement Strategies for Embodied Agents](https://arxiv.org/abs/2609.16056)
...
### [19] [OmniHarness: Harnessing Generalizable Visual Generation via Symbolic Policy Learning](https://arxiv.org/abs/2609.16057)
...
### [20] [Driver Behavior Estimation at Signalized Intersections Using a Physics-Constrained Decision-Conditioned Autoregressive Transformer](https://arxiv.org/abs/2609.16058)
...
### [21] [HintMiner: Automatic Question Hints Mining From Q&A Web Posts with Language Model via Self-Supervised Learning](https://arxiv.org/abs/2609.16060)
...
### [22] [POSPAN: Position-Constrained Span Masking for Language Model Pre-training](https://arxiv.org/abs/2609.16061)
...
### [23] [Signed p-adic Residual Encodings of Finite-Domain All-Different Systems with a Sudoku Case Study](https://arxiv.org/abs/2609.16063)
*Greg Baker*
...
### [24] [You Don't Need To Train: Agentic Heuristic Learning Studio for Executable Human Activity Recognition](https://arxiv.org/abs/2609.16065)
...
### [25] [A panoramic aerodynamic performance prediction method for turbomachinery cascades using transformer-enhanced neural operator](https://arxiv.org/abs/2609.16066)
...
### [26] [A Dynamic Aggregation Strategy Enhanced Efficient Global Optimization Algorithm for Solving High-Dimensional Turbomachinery Design Problems](https://arxiv.org/abs/2609.16067)
...
### [27] [Beyond Distribution Matching: Semantics-Consistent Tabular Diffusion with Weak Semantic Priors](https://arxiv.org/abs/2609.16069)
...
### [28] [Schema-Adaptive Action-Conditioned JEPA for Cross-Machine CNC Transfer under Partial Sensor Overlap](https://arxiv.org/abs/2609.16071)
...
### [29] [SWB-DM: A Calibrated Sliced-Wasserstein-Barycenter Aggregator with Delayed-Momentum Caching for Byzantine-Robust Federated Learning under Partial Participation](https://arxiv.org/abs/2609.16099)
...
### [30] [Pseudo-Label Augmentation for Affect Sensing in Small Collaborative Groups](https://arxiv.org/abs/2609.16077)
...
### [31] [Adaptive Bayesian Partner Selection for Federated Clinical Centers](https://arxiv.org/abs/2609.16446)
...
### [32] [Distilling Foundation Models for Agentic What-If Reasoning:Cost, Latency, and Governance in a Hybrid LLM+SLM Architecture](https://arxiv.org/abs/2609.16091)
...
### [33] [High-Performance Tensor Formulation of the Viterbi Algorithm for Hidden Semi-Markov Models](https://arxiv.org/abs/2609.16500)
...
### [34] [Evaluating Open-Weight E-Commerce Agents with Environment-Grounded Verification](https://arxiv.org/abs/2609.16093)
...
### [35] [Structural Negative Transfer in Federated Graph Neural Networks: Diagnosis, Causal Investigation, and the Limits of Divergence-Aware Mitigation](https://arxiv.org/abs/2609.16977)
...
### [36] [A Decision-Support Audit Protocol for Supervision Drift in Proxy-Labeled Credit-Risk Prediction](https://arxiv.org/abs/2609.16102)
...
### [37] [LLMs as Master Forgers: Generating Synthetic Time Series Data for Manufacturing](https://arxiv.org/abs/2609.16155)
...
### [38] [LLM Inference in a Flash!](https://arxiv.org/abs/2609.16161)
...
### [39] [Skeletal Prototypes on Iterative Nerve Expansions](https://arxiv.org/abs/2609.16170)
...
### [40] [Z-Loss Backward Geometry in Dense Output Heads and Sparse Routers](https://arxiv.org/abs/2609.16179)
*Bum Jun Kim*
...
### [41] [Anatomy of Associative Recall in Fixed-State Recurrences: A Matched-State Decomposition, an Interference Wall, and a Curriculum That Breaks It](https://arxiv.org/abs/2609.16183)
...
### [42] [Decoy Direction Optimization: A Post-Hoc Defense Against LLM Abliteration](https://arxiv.org/abs/2609.16204)
...
### [43] [How I learned to stop worrying and love StopGrads: Stationarity, Convergence, and a case study on Flow Map Learning](https://arxiv.org/abs/2609.16222)
...
### [44] [Test-Time Unlearning via Sparse Autoencoder](https://arxiv.org/abs/2609.16229)
...
### [45] [Efficient Reasoning Distillation: Small Video-Language Models via Synthetic CoT and Difficulty-Aware Fine-Tuning](https://arxiv.org/abs/2609.16255)
...
### [46] [The record is part of the task: matched-record evaluation of text classifiers across maintenance, safety and recall reporting](https://arxiv.org/abs/2609.16267)
...
### [47] [Scaling Laws for Physics-Aware ACOPF Surrogate Learning](https://arxiv.org/abs/2609.16282)
...
### [48] [Differentially Private Semantic Plans for Aggregate Insight Generation](https://arxiv.org/abs/2609.16283)
*Behrooz Razeghi*
...
### [49] [Drift Field Net: Learning Ocean Lagrangian advection fields from in-situ and satellite observations](https://arxiv.org/abs/2609.16288)
...
### [51] [Robust Fault Detection in Mechanical Multimodal Time Series via Self-Supervised Cross-Modal Reconstruction](https://arxiv.org/abs/2609.16314)
...
### [52] [Generative models for simulation based filtering: Formulations and Empirical Comparisons](https://arxiv.org/abs/2609.16317)
...
### [53] [Channel-Informed Neural Network for Physical Layer Key Generation](https://arxiv.org/abs/2609.16341)
...
### [54] [Multi-Label Proportion Learning for Sea-Ice Type Prediction](https://arxiv.org/abs/2609.16347)
...
### [55] [Federated stochastic bilevel optimization with fully first-order gradients](https://arxiv.org/abs/2609.16350)
...
### [56] [Autonomous Droplet Navigation via Model-Based Reinforcement Learning](https://arxiv.org/abs/2609.16369)
...
### [57] [Certified Uncertainty Propagation in One-Shot Federated Bayesian Models via Posterior Event Transport](https://arxiv.org/abs/2609.16373)
...
### [58] [Bounded Adjustment with Reliability-Guided Embedding for Imbalanced Learning with Noisy Labels](https://arxiv.org/abs/2609.16380)
...
### [59] [Attention Mean Fields Predict Average Representation Dynamics and Reveal Context-Specific Computation](https://arxiv.org/abs/2609.16382)
...
### [60] [How Good Are Time-Series Foundation Models for Pedestrian Crowd Count Forecasting? A Cross-Dataset Comparative Study](https://arxiv.org/abs/2609.16415)
...
### [62] [OPD-Aha: From Linguistic Momentum to Visual Reflection in Multimodal On-Policy Distillation](https://arxiv.org/abs/2609.16459)
...
### [63] [Online Gradient Computation for Warping Gaussian Process Transformations](https://arxiv.org/abs/2609.16472)
...
### [64] [Decoder Design Matters for ECG Delineation](https://arxiv.org/abs/2609.16489)
...
### [65] [FlowATC: Aircraft Trajectory Prediction via Flow Matching](https://arxiv.org/abs/2609.16528)
...
### [66] [What Does Layer-Importance Reveal About Transformers and State-Space Models?](https://arxiv.org/abs/2609.16537)
...
### [67] [On the Importance of Gating: Memorization vs. In-Context Learning in State Space Models](https://arxiv.org/abs/2609.16540)
...
### [68] [AsyncCouple-Flow: Asynchronous Cross-Modal Coupling and Flow Matching for Spatio-Temporal Forecasting](https://arxiv.org/abs/2609.16573)
...
### [69] [Recovering Physical Parameters from Fragmented Observations via Exact Distributed Spline Merging](https://arxiv.org/abs/2609.16579)
*Naveen Mysore*
...
### [70] [A Weighted Kernel Method for Approximation that Adapts to Learned Multivariable Structure](https://arxiv.org/abs/2609.16606)
...
### [71] [Divergence Timing and Cumulative Disagreement under KV-Cache Eviction](https://arxiv.org/abs/2609.16617)
*Xinyue Luo,Fei Yu*
...
### [72] [Stable by Construction: Variational Latent Markov Operators for Long-Horizon PDE Prediction](https://arxiv.org/abs/2609.16621)
...
### [73] [GrowMTP: Can RL Grow Its Own Draft Head?](https://arxiv.org/abs/2609.16648)
...
### [74] [Right Direction, Wrong Step: Geometric Analysis of Finite-Step Failure in Looped Transformers](https://arxiv.org/abs/2609.16665)
...
### [75] [Continuous-Time Machine Learning: A Unified Mathematical Perspective](https://arxiv.org/abs/2609.16710)
...
### [76] [A Systematic Evaluation of Machine Learning Methods for Fault Detection and Line Identification in Electrical Power Grids](https://arxiv.org/abs/2609.16744)
...
### [77] [TAME: Token Attribution and Masking for Emergent misalignment](https://arxiv.org/abs/2609.16754)
...
### [78] [Noise2Noise Revisited: Training Pair Distributions Dominate Loss Choice in Self-Supervised Denoising](https://arxiv.org/abs/2609.16788)
...
### [79] [SOTER: A Generative Time-Series Foundation Model for Wearable Human Physiological Signals](https://arxiv.org/abs/2609.16804)
...
### [80] [Geometry of learning dynamics: Gradient descent versus natural gradient on the ridge of optimization](https://arxiv.org/abs/2609.16805)
*Akira Tamamori*
...
### [81] [ImpossibleRubrics: Stress-Testing Generated Rubrics as Reward Signals](https://arxiv.org/abs/2609.16816)
...
### [82] [LCAP: Population-Informed Latent Chip Adaptation from Few Output Probes for Photonic Neural Networks](https://arxiv.org/abs/2609.16823)
...
### [83] [Adapting to Decision-Relevant Non-Stationarity in Decentralized Heterogeneous Bandits](https://arxiv.org/abs/2609.16824)
*Zhaojun Peng*
...
### [84] [Information Geometric Self-Organization at the Edge of Stability in High-Capacity Kernel Associative Memories](https://arxiv.org/abs/2609.16827)
*Akira Tamamori*
...
### [85] [Can Deep Learning Achieve Cross-Physics Mapping?](https://arxiv.org/abs/2609.16853)
...
### [86] [HyCoSeq: Contextual Hyperbolic Representation Learning for Genomic Sequences](https://arxiv.org/abs/2609.16925)
...
### [87] [Verbalizing Subliminal Learning Effects Using Text Optimization](https://arxiv.org/abs/2609.16927)
...
### [88] [Repurposing Deep Limit Order Book Forecasting for Scenario-Conditioned Market Impact Modeling](https://arxiv.org/abs/2609.16930)
...
### [89] [When Confidence Signals Disagree: Local and Global Confidence in Autoregressive Language Models](https://arxiv.org/abs/2609.16933)
...
### [90] [Beyond Token-Local Imitation: Reward-Compatible Temporal Credit Assignment for On-Policy Distillation](https://arxiv.org/abs/2609.16937)
...
### [91] [CLARE: Scalable Class-Incremental Continual Learning via a Sparsity-Based Framework](https://arxiv.org/abs/2609.17026)
...
### [92] [Distributed JEPA: A Self-Supervised Framework for Energy Forecasting](https://arxiv.org/abs/2609.17029)
...
### [93] [Learning Options for Compositional Motor Control with Adapter Banks](https://arxiv.org/abs/2609.17042)
...
### [94] [Repurposing Unified Topological Signatures for Graph Representation Learning](https://arxiv.org/abs/2609.17061)
...
### [95] [High-Fidelity Digital Twin Data Models by Randomized Dynamic Mode Decomposition and Deep Learning with Applications in Fluid Dynamics](https://arxiv.org/abs/2609.17101)
*Diana A. Bistrian*
...
### [96] [Neural Field Ensembles for Aerodynamic Surface Prediction: Winning Solution to the ONERA CRM Wall Distribution 2025 Challenge](https://arxiv.org/abs/2609.17160)
...
### [97] [A unified framework for global and local interpretability using adaptive derivative-ordered random explanation](https://arxiv.org/abs/2609.17171)
...
### [98] [IRENE: A Convolutional GRU Ensemble Model for Radar Precipitation Nowcasting over Italy](https://arxiv.org/abs/2609.17175)
...
### [99] [LoopSpec: Pipelined Self-Speculative Decoding for Looped Transformers](https://arxiv.org/abs/2609.17184)
...
### [100] [MyoFlow: Anchor-Tied Rectified Flow for HD-sEMG Gesture Recognition Across Sessions and Subjects](https://arxiv.org/abs/2609.17194)
...
### [101] [Memorisation bias in medical AI](https://arxiv.org/abs/2609.17223)
...
### [102] [Easy to Catch a Liar, Hard to Clear an Honest One: Language Models Diagnosing a Corrupted Reward Channel from a Verified Record](https://arxiv.org/abs/2609.17226)
*Arman Nik Khah*
...
### [103] [Personalized Federated Learning through Global Knowledge Distillation and Local Head Adaptation](https://arxiv.org/abs/2609.17284)
...
### [104] [Same Flow, Different Paths: Variance Reduction in Flow Matching](https://arxiv.org/abs/2609.17287)
*Alexander Tyurin*
...
### [105] [Hybrid Variational Quantum Circuits for Multivariate Regression and High-Dimensional Data Reconstruction](https://arxiv.org/abs/2609.17358)
...
### [106] [Large Language Models Develop Belief State Geometry In-Context](https://arxiv.org/abs/2609.17376)
...
### [107] [OPEN-1B: A Fully Auditable Training Run](https://arxiv.org/abs/2609.17380)
...
### [108] [Bridging the Confidence Gap: Temperature Scaling for Calibrating Test-Time Prompt Tuning](https://arxiv.org/abs/2609.17386)
...
### [109] [Knowledge as Orbit: Finite Collections as Phases of an Exactly Periodic Latent Generator](https://arxiv.org/abs/2609.17417)
...
### [110] [Learning-Guided Planning in Large Dynamic Action Spaces: Budgeted Tree Search for One-to-Many Mobile Charging](https://arxiv.org/abs/2609.17429)
...
### [111] [Reduced-Space Multi-Fidelity Bayesian Optimization of Process Simulation Models](https://arxiv.org/abs/2609.17440)
...
### [112] [Coupled Calibration and Learning: Mitigating Teacher Bias in LLM Distillation without Target-Domain Reward Feedback](https://arxiv.org/abs/2609.17474)
...
### [113] [FreqSpaNet: Frequency and Spatial Learning of SFPF for Physical Layer Hardware Integrity Detection](https://arxiv.org/abs/2609.17491)
...
### [114] [ENCP: Episode-Normalized Conformal Prediction for Vision-and-Language Navigation](https://arxiv.org/abs/2609.17499)
...
### [115] [Novel Iterative Construction Methods for the Blocking Job Shop Scheduling Problem](https://arxiv.org/abs/2609.16007)
...
### [116] [Co-Skill: A Collaborative Communication Framework for Skill Evolution](https://arxiv.org/abs/2609.16008)
...
### [117] [Vectorization Of Narrow Matrix Multiplication for Ascend AI Inference Acceleration](https://arxiv.org/abs/2609.16009)
...
### [118] [BOA: Beamwidth Online Adaptation for Filtered-ANNS on a GPU](https://arxiv.org/abs/2609.16175)
...
### [119] [Cognitive Admission Control: Risk-Conditioned Assurance for Consequential Actions in Agentic Distributed Systems](https://arxiv.org/abs/2609.16313)
*Jun He,Deying Yu*
...
### [120] [PipeSwift: Revisiting Pipeline Parallelism for Large-Scale Completion-Oriented Agentic Serving](https://arxiv.org/abs/2609.16491)
...
### [121] [XMPIaaS: Towards Cloud Native MPI via Cooperative Process Migration](https://arxiv.org/abs/2609.16531)
...
### [122] [DeepShare: Assurance-Driven Deep Learning Job Scheduling for Multi-Tenant Clusters](https://arxiv.org/abs/2609.16682)
...
### [123] [The Price of Random Access: Measuring Block Granularity Across Four Compressed Formats](https://arxiv.org/abs/2609.16731)
*Yakiv Shavidze*
...
### [124] [Nested Parallel von Neumann Architecture and Nested BSP](https://arxiv.org/abs/2609.16787)
*Heng Liao*
...
### [125] [Byzantine Reliable Broadcast with Causal Ordering](https://arxiv.org/abs/2609.17074)
...
### [126] [DS2-Based Cross-Data-Space Interoperability for Precision Agriculture](https://arxiv.org/abs/2609.17185)
