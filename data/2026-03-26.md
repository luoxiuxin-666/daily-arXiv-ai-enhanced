...
### [6] [Causal Reconstruction of Sentiment Signals from Sparse News Data](https://arxiv.org/abs/2603.23568)
...
### [7] [StateLinFormer: Stateful Training Enhancing Long-term Memory in Navigation](https://arxiv.org/abs/2603.23571)
...
### [8] [Dual-Criterion Curriculum Learning: Application to Temporal Data](https://arxiv.org/abs/2603.23573)
...
### [9] [PoiCGAN: A Targeted Poisoning Based on Feature-Label Joint Perturbation in Federated Learning](https://arxiv.org/abs/2603.23574)
...
### [10] [APreQEL: Adaptive Mixed Precision Quantization For Edge LLMs](https://arxiv.org/abs/2603.23575)
...
### [14] [AI Generalisation Gap In Comorbid Sleep Disorder Staging](https://arxiv.org/abs/2603.23582)
...
### [15] [LineMVGNN: Anti-Money Laundering with Line-Graph-Assisted Multi-View Graph Neural Networks](https://arxiv.org/abs/2603.23584)
...
### [16] [A Theory of LLM Information Susceptibility](https://arxiv.org/abs/2603.23626)
...
### [17] [Steering Code LLMs with Activation Directions for Language and Library Control](https://arxiv.org/abs/2603.23629)
...
### [18] [Boost Like a (Var)Pro: Trust-Region Gradient Boosting via Variable Projection](https://arxiv.org/abs/2603.23658)
...
### [19] [CDMT-EHR: A Continuous-Time Diffusion Framework for Generating Mixed-Type Time-Series Electronic Health Records](https://arxiv.org/abs/2603.23719)
...
### [20] [BXRL: Behavior-Explainable Reinforcement Learning](https://arxiv.org/abs/2603.23738)
...
### [24] [Probabilistic Geometric Alignment via Bayesian Latent Transport for Domain-Adaptive Foundation Models](https://arxiv.org/abs/2603.23783)
...
### [25] [Latent Algorithmic Structure Precedes Grokking: A Mechanistic Study of ReLU MLPs on Modular Arithmetic](https://arxiv.org/abs/2603.23784)
*Anand Swaroop*
...
### [26] [Manifold Generalization Provably Proceeds Memorization in Diffusion Models](https://arxiv.org/abs/2603.23792)
...
### [27] [Resolving gradient pathology in physics-informed epidemiological models](https://arxiv.org/abs/2603.23799)
...
### [28] [Deep Neural Regression Collapse](https://arxiv.org/abs/2603.23805)
...
### [31] [Symbolic--KAN: Kolmogorov-Arnold Networks with Discrete Symbolic Structure for Interpretable Learning](https://arxiv.org/abs/2603.23854)
...
### [32] [Why the Maximum Second Derivative of Activations Matters for Adversarial Robustness](https://arxiv.org/abs/2603.23860)
...
### [33] [An Invariant Compiler for Neural ODEs in AI-Accelerated Scientific Simulation](https://arxiv.org/abs/2603.23861)
...
### [34] [Deep Convolutional Neural Networks for predicting highest priority functional group in organic molecules](https://arxiv.org/abs/2603.23862)
...
### [35] [Can VLMs Reason Robustly? A Neuro-Symbolic Investigation](https://arxiv.org/abs/2603.23867)
...
### [37] [The Luna Bound Propagator for Formal Analysis of Neural Networks](https://arxiv.org/abs/2603.23878)
...
### [38] [Off-Policy Safe Reinforcement Learning with Constrained Optimistic Exploration](https://arxiv.org/abs/2603.23889)
...
### [39] [Optimal Variance-Dependent Regret Bounds for Infinite-Horizon MDPs](https://arxiv.org/abs/2603.23926)
...
### [40] [GRMLR: Knowledge-Enhanced Small-Data Learning for Deep-Sea Cold Seep Stage Inference](https://arxiv.org/abs/2603.23961)
...
### [41] [Wireless communication empowers online scheduling of partially-observable transportation multi-robot systems in a smart factory](https://arxiv.org/abs/2603.23967)
...
### [42] [Kirchhoff-Inspired Neural Networks for Evolving High-Order Perception](https://arxiv.org/abs/2603.23977)
...
### [43] [Transcending Classical Neural Network Boundaries: A Quantum-Classical Synergistic Paradigm for Seismic Data Processing](https://arxiv.org/abs/2603.23984)
...
### [44] [Diet Your LLM: Dimension-wise Global Pruning of LLMs via Merging Task-specific Importance Score](https://arxiv.org/abs/2603.23985)
...
### [45] [Can we generate portable representations for clinical time series data using LLMs?](https://arxiv.org/abs/2603.23987)
...
### [46] [Understanding the Challenges in Iterative Generative Optimization with LLMs](https://arxiv.org/abs/2603.23994)
...
### [47] [Stochastic Dimension-Free Zeroth-Order Estimator for High-Dimensional and High-Order PINNs](https://arxiv.org/abs/2603.24002)
...
### [48] [i-IF-Learn: Iterative Feature Selection and Unsupervised Learning for High-Dimensional Complex Data](https://arxiv.org/abs/2603.24025)
...
### [49] [Lagrangian Relaxation Score-based Generation for Mixed Integer linear Programming](https://arxiv.org/abs/2603.24033)
...
### [50] [MoE-Sieve: Routing-Guided LoRA for Efficient MoE Fine-Tuning](https://arxiv.org/abs/2603.24044)
*Andrea Manzoni*
...
### [51] [The impact of sensor placement on graph-neural-network-based leakage detection](https://arxiv.org/abs/2603.24076)
...
### [53] [KCLNet: Electrically Equivalence-Oriented Graph Representation Learning for Analog Circuits](https://arxiv.org/abs/2603.24101)
...
### [54] [Causality-Driven Disentangled Representation Learning in Multiplex Graphs](https://arxiv.org/abs/2603.24105)
...
### [55] [Mixed-signal implementation of feedback-control optimizer for single-layer Spiking Neural Networks](https://arxiv.org/abs/2603.24113)
...
### [56] [Likelihood hacking in probabilistic program synthesis](https://arxiv.org/abs/2603.24126)
...
### [57] [On Gossip Algorithms for Machine Learning with Pairwise Objectives](https://arxiv.org/abs/2603.24128)
...
### [58] [Reservoir-Based Graph Convolutional Networks](https://arxiv.org/abs/2603.24131)
...
### [59] [Efficient Controller Learning from Human Preferences and Numerical Data Via Multi-Modal Surrogate Models](https://arxiv.org/abs/2603.24138)
...
### [60] [Linear-Nonlinear Fusion Neural Operator for Partial Differential Equations](https://arxiv.org/abs/2603.24143)
...
### [70] [Cost-Sensitive Neighborhood Aggregation for Heterophilous Graphs: When Does Per-Edge Routing Help?](https://arxiv.org/abs/2603.24291)
*Eyal Weiss*
...
### [71] [Large Language Model Guided Incentive Aware Reward Design for Cooperative Multi-Agent Reinforcement Learning](https://arxiv.org/abs/2603.24324)
...
### [72] [CoordLight: Learning Decentralized Coordination for Network-Wide Traffic Signal Control](https://arxiv.org/abs/2603.24366)
...
### [73] [MolEvolve: LLM-Guided Evolutionary Search for Interpretable Molecular Optimization](https://arxiv.org/abs/2603.24382)
...
### [74] [On the Use of Bagging for Local Intrinsic Dimensionality Estimation](https://arxiv.org/abs/2603.24384)
...
### [75] [Marchuk: Efficient Global Weather Forecasting from Mid-Range to Sub-Seasonal Scales via Flow Matching](https://arxiv.org/abs/2603.24428)
...
### [76] [Learning Response-Statistic Shifts and Parametric Roll Episodes from Wave--Vessel Time Series via LSTM Functional Models](https://arxiv.org/abs/2603.24431)
...
### [77] [CUA-Suite: Massive Human-annotated Video Demonstrations for Computer-Use Agents](https://arxiv.org/abs/2603.24440)
...
### [78] [Conformalized Transfer Learning for Li-ion Battery State of Health Forecasting under Manufacturing and Usage Variability](https://arxiv.org/abs/2603.24475)
...
### [79] [Uniform Laws of Large Numbers in Product Spaces](https://arxiv.org/abs/2603.24493)
...
### [80] [Project and Generate: Divergence-Free Neural Operators for Incompressible Flows](https://arxiv.org/abs/2603.24500)
...
### [81] [Towards Safe Learning-Based Non-Linear Model Predictive Control through Recurrent Neural Network Modeling](https://arxiv.org/abs/2603.24503)
...
### [83] [AVO: Agentic Variation Operators for Autonomous Evolutionary Search](https://arxiv.org/abs/2603.24517)
...
### [84] [TuneShift-KD: Knowledge Distillation and Transfer for Fine-tuned Models](https://arxiv.org/abs/2603.24518)
...
### [85] [No Single Metric Tells the Whole Story: A Multi-Dimensional Evaluation Framework for Uncertainty Attributions](https://arxiv.org/abs/2603.24524)
...
### [86] [UI-Voyager: A Self-Evolving GUI Agent Learning via Failed Experience](https://arxiv.org/abs/2603.24533)
...
### [87] [Scaling Recurrence-aware Foundation Models for Clinical Records via Next-Visit Prediction](https://arxiv.org/abs/2603.24562)
...
### [88] [DreamerAD: Efficient Reinforcement Learning via Latent World Model for Autonomous Driving](https://arxiv.org/abs/2603.24587)
...
### [89] [Polynomial Speedup in Diffusion Models with the Multilevel Euler-Maruyama Method](https://arxiv.org/abs/2603.24594)
*Arthur Jacot*
...
### [90] [Efficient Equilibrium Computation in Symmetric First-Price Auctions](https://arxiv.org/abs/2603.24317)
...
### [91] [Self-Evolving Multi-Agent Framework for Efficient Decision Making in Real-Time Strategy Scenarios](https://arxiv.org/abs/2603.23875)
...
### [92] [Relaxing Constraints in Anonymous Multi Agent Path Finding for Large Agents](https://arxiv.org/abs/2603.24442)
...
### [93] [LLM Inference at the Edge: Mobile, NPU, and GPU Performance Efficiency Trade-offs Under Sustained Load](https://arxiv.org/abs/2603.23640)
...
### [94] [The Evolution of Decentralized Systems: From Gray's Framework to Blockchain and Beyond](https://arxiv.org/abs/2603.23819)
...
### [95] [Supermassive Blockchain](https://arxiv.org/abs/2603.23927)
